...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Collectivite.indice'
        db.delete_column(u'collectivite', 'indice')

        # Deleting field 'Personne.indice'
        db.delete_column(u'personne', 'indice')

        # Deleting field 'Role.indice'
        db.delete_column(u'role', 'indice')
