...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Oeuvre.supprime'
        db.delete_column(u'oeuvre', 'supprime')

        # Deleting field 'VideoRecord.supprime'
        db.delete_column(u'video_record', 'supprime')

        # Deleting field 'Evenement.supprime'
        db.delete_column(u'evenement', 'supprime')

        # Deleting field 'TypeEvenement.supprime'
        db.delete_column(u'type_evenement', 'supprime')

        # Deleting field 'Collectivite.supprime'
        db.delete_column(u'collectivite', 'supprime')

        # Deleting field 'VideoVolume.supprime'
        db.delete_column(u'video_volume', 'supprime')

        # Deleting field 'Evenement2.supprime'
        db.delete_column(u'evenement2', 'supprime')

        # Deleting field 'NoteProgramme.supprime'
        db.delete_column(u'note_programme', 'supprime')

        # Deleting field 'Volume.supprime'
        db.delete_column(u'volume', 'supprime')

        # Deleting field 'Lieu.supprime'
        db.delete_column(u'lieu', 'supprime')

        # Deleting field 'Personne.supprime'
        db.delete_column(u'personne', 'supprime')

        # Deleting field 'Contrat.supprime'
        db.delete_column(u'contrat', 'supprime')

        # Deleting field 'Partie.supprime'
        db.delete_column(u'partie', 'supprime')

        # Deleting field 'Utilisateur.supprime'
        db.delete_column(u'utilisateur', 'supprime')

        # Deleting field 'Role.supprime'
        db.delete_column(u'role', 'supprime')

        # Deleting field 'VideoSet.supprime'
        db.delete_column(u'video_set', 'supprime')


    def backwards(self, orm):
        # Adding field 'Oeuvre.supprime'
        db.add_column(u'oeuvre', 'supprime',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'VideoRecord.supprime'
        db.add_column(u'video_record', 'supprime',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Evenement.supprime'
        db.add_column(u'evenement', 'supprime',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'TypeEvenement.supprime'
        db.add_column(u'type_evenement', 'supprime',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Collectivite.supprime'
        db.add_column(u'collectivite', 'supprime',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'VideoVolume.supprime'
        db.add_column(u'video_volume', 'supprime',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Evenement2.supprime'
        db.add_column(u'evenement2', 'supprime',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'NoteProgramme.supprime'
        db.add_column(u'note_programme', 'supprime',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Volume.supprime'
        db.add_column(u'volume', 'supprime',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Lieu.supprime'
        db.add_column(u'lieu', 'supprime',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Personne.supprime'
        db.add_column(u'personne', 'supprime',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Contrat.supprime'
        db.add_column(u'contrat', 'supprime',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Partie.supprime'
        db.add_column(u'partie', 'supprime',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Utilisateur.supprime'
        db.add_column(u'utilisateur', 'supprime',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Role.supprime'
        db.add_column(u'role', 'supprime',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'VideoSet.supprime'
        db.add_column(u'video_set', 'supprime',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
