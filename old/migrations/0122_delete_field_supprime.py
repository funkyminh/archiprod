...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        cursor1.execute("DELETE FROM type_evenement WHERE supprime = 1")
        transaction.commit_unless_managed()

        cursor2 = connection.cursor()
        cursor2.execute("DELETE FROM utilisateur WHERE supprime = 1")
        transaction.commit_unless_managed()

        cursor3 = connection.cursor()
        cursor3.execute("DELETE FROM personne WHERE supprime = 1")
        transaction.commit_unless_managed()

        cursor4 = connection.cursor()
        cursor4.execute("DELETE FROM role WHERE supprime = 1")
        transaction.commit_unless_managed()

        cursor5 = connection.cursor()
        cursor5.execute("DELETE FROM evenement WHERE supprime = 1")
        transaction.commit_unless_managed()

        cursor6 = connection.cursor()
        cursor6.execute("DELETE FROM evenement2 WHERE supprime = 1")
        transaction.commit_unless_managed()

        cursor7 = connection.cursor()
        cursor7.execute("DELETE FROM lieu WHERE supprime = 1")
        transaction.commit_unless_managed()

        cursor8 = connection.cursor()
        cursor8.execute("DELETE FROM note_programme WHERE supprime = 1")
        transaction.commit_unless_managed()

        cursor9 = connection.cursor()
        cursor9.execute("DELETE FROM oeuvre WHERE supprime = 1")
        transaction.commit_unless_managed()

        cursor10 = connection.cursor()
        cursor10.execute("DELETE FROM video_volume WHERE supprime = 1")
        transaction.commit_unless_managed()

        cursor11 = connection.cursor()
        cursor11.execute("DELETE FROM contrat WHERE supprime = 1")
        transaction.commit_unless_managed()

        cursor12 = connection.cursor()
        cursor12.execute("DELETE FROM video_record WHERE supprime = 1")
        transaction.commit_unless_managed()

        cursor13 = connection.cursor()
        cursor13.execute("DELETE FROM video_set WHERE supprime = 1")
        transaction.commit_unless_managed()

        cursor14 = connection.cursor()
        cursor14.execute("DELETE FROM volume WHERE supprime = 1")
        transaction.commit_unless_managed()

        cursor15 = connection.cursor()
        cursor15.execute("DELETE FROM partie WHERE supprime = 1")
        transaction.commit_unless_managed()

        cursor16 = connection.cursor()
        cursor16.execute("DELETE FROM collectivite WHERE supprime = 1")
        transaction.commit_unless_managed()

        cursor17 = connection.cursor()
        cursor17.execute("DELETE FROM partie_collectivite WHERE partie_id in (SELECT id FROM partie WHERE supprime=1)")
        transaction.commit_unless_managed()

        cursor18 = connection.cursor()
        cursor18.execute("DELETE FROM video_volume_collectivite WHERE video_volume_id in (SELECT id FROM video_volume WHERE supprime=1)")
        transaction.commit_unless_managed()

        cursor19 = connection.cursor()
        cursor19.execute("DELETE FROM volume_collectivite WHERE volume_id in (SELECT id FROM volume WHERE supprime=1)")
        transaction.commit_unless_managed()

        cursor20 = connection.cursor()
        cursor20.execute("DELETE FROM video_record_collectivite WHERE video_record_id in (SELECT id FROM video_record WHERE supprime=1)")
        transaction.commit_unless_managed()
