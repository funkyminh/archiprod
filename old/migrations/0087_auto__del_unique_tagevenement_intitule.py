...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'TagEvenement', fields ['intitule']
        db.delete_unique(u'tag_evenement', ['intitule'])


    def backwards(self, orm):
        # Adding unique constraint on 'TagEvenement', fields ['intitule']
        db.create_unique(u'tag_evenement', ['intitule'])
