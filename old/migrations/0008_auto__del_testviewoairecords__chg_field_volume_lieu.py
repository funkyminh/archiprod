...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column(u'volume', 'lieu', 'lieu_id')
        # Changing field 'Volume.lieu'
        db.alter_column(u'volume', 'lieu_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Lieu']))
        # Adding index on 'Volume', fields ['lieu']
        db.create_index(u'volume', ['lieu_id'])
