...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Evenement.flag_archive'
        db.add_column(u'evenement', 'flag_archive',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Evenement.flag_categorie'
        db.add_column(u'evenement', 'flag_categorie',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Evenement.flag_archive'
        db.delete_column(u'evenement', 'flag_archive')

        # Deleting field 'Evenement.flag_categorie'
        db.delete_column(u'evenement', 'flag_categorie')
