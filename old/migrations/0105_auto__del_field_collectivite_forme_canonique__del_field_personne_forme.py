...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Collectivite.forme_canonique'
        db.delete_column(u'collectivite', 'forme_canonique_id')

        # Deleting field 'Personne.forme_canonique'
        db.delete_column(u'personne', 'forme_canonique_id')

        # Deleting field 'Role.forme_canonique'
        db.delete_column(u'role', 'forme_canonique_id')


    def backwards(self, orm):
        # Adding field 'Collectivite.forme_canonique'
        db.add_column(u'collectivite', 'forme_canonique',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Collectivite'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Personne.forme_canonique'
        db.add_column(u'personne', 'forme_canonique',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Personne'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Role.forme_canonique'
        db.add_column(u'role', 'forme_canonique',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Role'], null=True, blank=True),
                      keep_default=False)
