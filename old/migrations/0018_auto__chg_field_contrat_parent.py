...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Contrat.parent' to match new field type.
        db.rename_column(u'contrat', 'parent', 'parent_id')
        # Changing field 'Contrat.parent'
        db.alter_column(u'contrat', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.VideoVolume']))
        # Adding index on 'Contrat', fields ['parent']
        db.create_index(u'contrat', ['parent_id'])


    def backwards(self, orm):
        # Removing index on 'Contrat', fields ['parent']
        db.delete_index(u'contrat', ['parent_id'])


        # Renaming column for 'Contrat.parent' to match new field type.
        db.rename_column(u'contrat', 'parent_id', 'parent')
        # Changing field 'Contrat.parent'
        db.alter_column(u'contrat', 'parent', self.gf('django.db.models.fields.CharField')(max_length=48))
