...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'VideoRecord.archived'
        db.delete_column(u'video_record', 'archived')

        # Deleting field 'VideoRecord.online'
        db.delete_column(u'video_record', 'online')

        # Deleting field 'VideoRecord.type'
        db.delete_column(u'video_record', 'type')

        # Deleting field 'VideoRecord.temp_file_name'
        db.delete_column(u'video_record', 'temp_file_name')

        # Deleting field 'VideoRecord.old_y'
        db.delete_column(u'video_record', 'old_y')

        # Deleting field 'VideoRecord.old_x'
        db.delete_column(u'video_record', 'old_x')

        # Deleting field 'VideoRecord.archived_file_name'
        db.delete_column(u'video_record', 'archived_file_name')

        # Deleting field 'VideoRecord.new_x'
        db.delete_column(u'video_record', 'new_x')

        # Deleting field 'VideoRecord.new_y'
        db.delete_column(u'video_record', 'new_y')

        # Deleting field 'Evenement.video_children'
        db.delete_column(u'evenement', 'video_children')

        # Deleting field 'Evenement.audio_children'
        db.delete_column(u'evenement', 'audio_children')

        # Deleting field 'Evenement.pdf_children'
        db.delete_column(u'evenement', 'pdf_children')

        # Deleting field 'Evenement.event_children'
        db.delete_column(u'evenement', 'event_children')

        # Deleting field 'Volume.intitule'
        db.delete_column(u'volume', 'intitule')

        # Deleting field 'Volume.label'
        db.delete_column(u'volume', 'label')

        # Deleting field 'Volume.doris_key'
        db.delete_column(u'volume', 'doris_key')

        # Deleting field 'Volume.cddb'
        db.delete_column(u'volume', 'CDDB')

        # Deleting field 'Volume.auteur'
        db.delete_column(u'volume', 'auteur')

        # Deleting field 'Volume.annee'
        db.delete_column(u'volume', 'annee')

        # Deleting field 'Volume.url'
        db.delete_column(u'volume', 'url')

        # Deleting field 'Personne.doris_key'
        db.delete_column(u'personne', 'doris_key')

        # Deleting field 'Personne.brahms_key'
        db.delete_column(u'personne', 'brahms_key')

        # Deleting field 'Personne.fonction'
        db.delete_column(u'personne', 'fonction')

        # Deleting field 'Contrat.mime_type'
        db.delete_column(u'contrat', 'mime_type')

        # Deleting field 'Partie.doris_key'
        db.delete_column(u'partie', 'doris_key')

        # Deleting field 'Partie.partype'
        db.delete_column(u'partie', 'partype')

        # Deleting field 'Partie.auteur1'
        db.delete_column(u'partie', 'auteur1')

        # Deleting field 'Partie.auteur3'
        db.delete_column(u'partie', 'auteur3')

        # Deleting field 'Partie.auteur2'
        db.delete_column(u'partie', 'auteur2')

        # Deleting field 'Partie.auteur4'
        db.delete_column(u'partie', 'auteur4')

        # Deleting field 'Partie.resume'
        db.delete_column(u'partie', 'resume')

        # Deleting field 'Partie.brahms_key'
        db.delete_column(u'partie', 'brahms_key')


    def backwards(self, orm):
        # Adding field 'VideoRecord.archived'
        db.add_column(u'video_record', 'archived',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VideoRecord.online'
        db.add_column(u'video_record', 'online',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VideoRecord.type'
        db.add_column(u'video_record', 'type',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VideoRecord.temp_file_name'
        db.add_column(u'video_record', 'temp_file_name',
                      self.gf('django.db.models.fields.CharField')(max_length=384, null=True, blank=True),
                      keep_default=False)

        # Adding field 'VideoRecord.old_y'
        db.add_column(u'video_record', 'old_y',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VideoRecord.old_x'
        db.add_column(u'video_record', 'old_x',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VideoRecord.archived_file_name'
        db.add_column(u'video_record', 'archived_file_name',
                      self.gf('django.db.models.fields.CharField')(max_length=192, null=True, blank=True),
                      keep_default=False)

        # Adding field 'VideoRecord.new_x'
        db.add_column(u'video_record', 'new_x',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VideoRecord.new_y'
        db.add_column(u'video_record', 'new_y',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Evenement.video_children'
        db.add_column(u'evenement', 'video_children',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Evenement.audio_children'
        db.add_column(u'evenement', 'audio_children',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Evenement.pdf_children'
        db.add_column(u'evenement', 'pdf_children',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Evenement.event_children'
        db.add_column(u'evenement', 'event_children',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Volume.intitule'
        db.add_column(u'volume', 'intitule',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Volume.label'
        db.add_column(u'volume', 'label',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Volume.doris_key'
        db.add_column(u'volume', 'doris_key',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Volume.cddb'
        db.add_column(u'volume', 'cddb',
                      self.gf('django.db.models.fields.CharField')(max_length=24, null=True, db_column='CDDB', blank=True),
                      keep_default=False)

        # Adding field 'Volume.auteur'
        db.add_column(u'volume', 'auteur',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Volume.annee'
        db.add_column(u'volume', 'annee',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Volume.url'
        db.add_column(u'volume', 'url',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Personne.doris_key'
        db.add_column(u'personne', 'doris_key',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Personne.brahms_key'
        db.add_column(u'personne', 'brahms_key',
                      self.gf('django.db.models.fields.CharField')(max_length=27, null=True, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Personne.fonction'
        raise RuntimeError("Cannot reverse this migration. 'Personne.fonction' and its values cannot be restored.")
        # Adding field 'Contrat.mime_type'
        db.add_column(u'contrat', 'mime_type',
                      self.gf('django.db.models.fields.CharField')(max_length=765, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Partie.doris_key'
        db.add_column(u'partie', 'doris_key',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Partie.partype'
        raise RuntimeError("Cannot reverse this migration. 'Partie.partype' and its values cannot be restored.")
        # Adding field 'Partie.auteur1'
        db.add_column(u'partie', 'auteur1',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Partie.auteur3'
        db.add_column(u'partie', 'auteur3',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Partie.auteur2'
        db.add_column(u'partie', 'auteur2',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Partie.auteur4'
        db.add_column(u'partie', 'auteur4',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Partie.resume'
        db.add_column(u'partie', 'resume',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Partie.brahms_key'
        db.add_column(u'partie', 'brahms_key',
                      self.gf('django.db.models.fields.CharField')(max_length=27, null=True, blank=True),
                      keep_default=False)
