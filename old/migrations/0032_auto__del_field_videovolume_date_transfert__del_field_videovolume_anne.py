...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'VideoVolume.date_transfert'
        db.delete_column(u'video_volume', 'date_transfert')

        # Deleting field 'VideoVolume.annee'
        db.delete_column(u'video_volume', 'annee')


        # Changing field 'VideoVolume.sort'
        db.alter_column(u'video_volume', 'sort', self.gf('django.db.models.fields.CharField')(max_length=12, null=True))

        # Changing field 'VideoVolume.parent'
        db.alter_column(u'video_volume', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Evenement'], null=True))

        # Changing field 'VideoVolume.resume'
        db.alter_column(u'video_volume', 'resume', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'VideoVolume.horaire'
        db.alter_column(u'video_volume', 'horaire', self.gf('django.db.models.fields.CharField')(max_length=5, null=True))

        # Changing field 'VideoVolume.time_stamp'
        db.alter_column(u'video_volume', 'time_stamp', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):
        '''
        # Adding field 'VideoVolume.date_transfert'
        db.add_column(u'video_volume', 'date_transfert',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VideoVolume.annee'
        db.add_column(u'video_volume', 'annee',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)
        

        # User chose to not deal with backwards NULL issues for 'VideoVolume.sort'
        raise RuntimeError("Cannot reverse this migration. 'VideoVolume.sort' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'VideoVolume.parent'
        raise RuntimeError("Cannot reverse this migration. 'VideoVolume.parent' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'VideoVolume.resume'
        raise RuntimeError("Cannot reverse this migration. 'VideoVolume.resume' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'VideoVolume.horaire'
        raise RuntimeError("Cannot reverse this migration. 'VideoVolume.horaire' and its values cannot be restored.")

        # Changing field 'VideoVolume.time_stamp'
        db.alter_column(u'video_volume', 'time_stamp', self.gf('django.db.models.fields.DateTimeField')())
        '''
        pass
