...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'VolumeCollectivite.collectivite' to match new field type.
        db.rename_column(u'volume_collectivite', 'collectivite', 'collectivite_id')
        # Changing field 'VolumeCollectivite.collectivite'
        db.alter_column(u'volume_collectivite', 'collectivite_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Collectivite']))
        # Adding index on 'VolumeCollectivite', fields ['collectivite']
        db.create_index(u'volume_collectivite', ['collectivite_id'])


    def backwards(self, orm):
        # Removing index on 'VolumeCollectivite', fields ['collectivite']
        db.delete_index(u'volume_collectivite', ['collectivite_id'])


        # Renaming column for 'VolumeCollectivite.collectivite' to match new field type.
        db.rename_column(u'volume_collectivite', 'collectivite_id', 'collectivite')
        # Changing field 'VolumeCollectivite.collectivite'
        db.alter_column(u'volume_collectivite', 'collectivite', self.gf('django.db.models.fields.IntegerField')())
