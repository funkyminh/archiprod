...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'VideoSet.parent' to match new field type.
        db.rename_column(u'video_set', 'parent', 'parent_id')
        # Changing field 'VideoSet.parent'
        db.alter_column(u'video_set', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.VideoSet']))
        # Adding index on 'VideoSet', fields ['parent']
        db.create_index(u'video_set', ['parent_id'])


    def backwards(self, orm):
        # Removing index on 'VideoSet', fields ['parent']
        db.delete_index(u'video_set', ['parent_id'])


        # Renaming column for 'VideoSet.parent' to match new field type.
        db.rename_column(u'video_set', 'parent_id', 'parent')
        # Changing field 'VideoSet.parent'
        db.alter_column(u'video_set', 'parent', self.gf('django.db.models.fields.IntegerField')())
