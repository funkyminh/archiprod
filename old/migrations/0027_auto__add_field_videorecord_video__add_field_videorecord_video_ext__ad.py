...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VideoRecord.video'
        db.add_column(u'video_record', 'video',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'VideoRecord.video_ext'
        db.add_column(u'video_record', 'video_ext',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'VideoRecord.video_int'
        db.add_column(u'video_record', 'video_int',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VideoRecord.video'
        db.delete_column(u'video_record', 'video')

        # Deleting field 'VideoRecord.video_ext'
        db.delete_column(u'video_record', 'video_ext')

        # Deleting field 'VideoRecord.video_int'
        db.delete_column(u'video_record', 'video_int')
