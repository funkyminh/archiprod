...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'VideoRecord.parent' to match new field type.
        db.rename_column(u'video_record', 'parent', 'parent_id')
        # Changing field 'VideoRecord.parent'
        db.alter_column(u'video_record', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.VideoVolume']))
        # Adding index on 'VideoRecord', fields ['parent']
        db.create_index(u'video_record', ['parent_id'])


    def backwards(self, orm):
        # Removing index on 'VideoRecord', fields ['parent']
        db.delete_index(u'video_record', ['parent_id'])


        # Renaming column for 'VideoRecord.parent' to match new field type.
        db.rename_column(u'video_record', 'parent_id', 'parent')
        # Changing field 'VideoRecord.parent'
        db.alter_column(u'video_record', 'parent', self.gf('django.db.models.fields.CharField')(max_length=48))
