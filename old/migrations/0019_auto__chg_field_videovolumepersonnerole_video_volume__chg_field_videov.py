...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'VideoVolumePersonneRole.video_volume' to match new field type.
        db.rename_column(u'video_volume_personne_role', 'video_volume', 'video_volume_id')
        # Changing field 'VideoVolumePersonneRole.video_volume'
        db.alter_column(u'video_volume_personne_role', 'video_volume_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.VideoVolume']))
        # Adding index on 'VideoVolumePersonneRole', fields ['video_volume']
        db.create_index(u'video_volume_personne_role', ['video_volume_id'])


        # Renaming column for 'VideoVolumeCollectivite.video_volume' to match new field type.
        db.rename_column(u'video_volume_collectivite', 'video_volume', 'video_volume_id')
        # Changing field 'VideoVolumeCollectivite.video_volume'
        db.alter_column(u'video_volume_collectivite', 'video_volume_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.VideoVolume']))
        # Adding index on 'VideoVolumeCollectivite', fields ['video_volume']
        db.create_index(u'video_volume_collectivite', ['video_volume_id'])


    def backwards(self, orm):
        # Removing index on 'VideoVolumeCollectivite', fields ['video_volume']
        db.delete_index(u'video_volume_collectivite', ['video_volume_id'])

        # Removing index on 'VideoVolumePersonneRole', fields ['video_volume']
        db.delete_index(u'video_volume_personne_role', ['video_volume_id'])


        # Renaming column for 'VideoVolumePersonneRole.video_volume' to match new field type.
        db.rename_column(u'video_volume_personne_role', 'video_volume_id', 'video_volume')
        # Changing field 'VideoVolumePersonneRole.video_volume'
        db.alter_column(u'video_volume_personne_role', 'video_volume', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Renaming column for 'VideoVolumeCollectivite.video_volume' to match new field type.
        db.rename_column(u'video_volume_collectivite', 'video_volume_id', 'video_volume')
        # Changing field 'VideoVolumeCollectivite.video_volume'
        db.alter_column(u'video_volume_collectivite', 'video_volume', self.gf('django.db.models.fields.CharField')(max_length=30))
