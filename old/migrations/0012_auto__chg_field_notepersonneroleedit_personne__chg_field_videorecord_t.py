...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'NotePersonneRoleEdit.personne' to match new field type.
        db.rename_column(u'note_personne_role_edit', 'personne', 'personne_id')
        # Changing field 'NotePersonneRoleEdit.personne'
        db.alter_column(u'note_personne_role_edit', 'personne_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Personne']))
        # Adding index on 'NotePersonneRoleEdit', fields ['personne']
        db.create_index(u'note_personne_role_edit', ['personne_id'])


        # Renaming column for 'VideoRecord.technicien' to match new field type.
        db.rename_column(u'video_record', 'technicien', 'technicien_id')
        # Changing field 'VideoRecord.technicien'
        db.alter_column(u'video_record', 'technicien_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Utilisateur']))
        # Adding index on 'VideoRecord', fields ['technicien']
        db.create_index(u'video_record', ['technicien_id'])


        # Renaming column for 'VideoVolume.technicien' to match new field type.
        db.rename_column(u'video_volume', 'technicien', 'technicien_id')
        # Changing field 'VideoVolume.technicien'
        db.alter_column(u'video_volume', 'technicien_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Utilisateur']))
        # Adding index on 'VideoVolume', fields ['technicien']
        db.create_index(u'video_volume', ['technicien_id'])


        # Renaming column for 'VideoVolumePersonneRole.personne' to match new field type.
        db.rename_column(u'video_volume_personne_role', 'personne', 'personne_id')
        # Changing field 'VideoVolumePersonneRole.personne'
        db.alter_column(u'video_volume_personne_role', 'personne_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Personne']))
        # Adding index on 'VideoVolumePersonneRole', fields ['personne']
        db.create_index(u'video_volume_personne_role', ['personne_id'])


        # Renaming column for 'NoteProgramme.technicien' to match new field type.
        db.rename_column(u'note_programme', 'technicien', 'technicien_id')
        # Changing field 'NoteProgramme.technicien'
        db.alter_column(u'note_programme', 'technicien_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Utilisateur']))
        # Adding index on 'NoteProgramme', fields ['technicien']
        db.create_index(u'note_programme', ['technicien_id'])


        # Renaming column for 'VideoRecordPersonneRole.personne' to match new field type.
        db.rename_column(u'video_record_personne_role', 'personne', 'personne_id')
        # Changing field 'VideoRecordPersonneRole.personne'
        db.alter_column(u'video_record_personne_role', 'personne_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Personne']))
        # Adding index on 'VideoRecordPersonneRole', fields ['personne']
        db.create_index(u'video_record_personne_role', ['personne_id'])


        # Renaming column for 'OeuvrePersonneRole.personne' to match new field type.
        db.rename_column(u'oeuvre_personne_role', 'personne', 'personne_id')
        # Changing field 'OeuvrePersonneRole.personne'
        db.alter_column(u'oeuvre_personne_role', 'personne_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Personne']))
        # Adding index on 'OeuvrePersonneRole', fields ['personne']
        db.create_index(u'oeuvre_personne_role', ['personne_id'])


        # Renaming column for 'Contrat.technicien' to match new field type.
        db.rename_column(u'contrat', 'technicien', 'technicien_id')
        # Changing field 'Contrat.technicien'
        db.alter_column(u'contrat', 'technicien_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Utilisateur']))
        # Adding index on 'Contrat', fields ['technicien']
        db.create_index(u'contrat', ['technicien_id'])


    def backwards(self, orm):
        # Removing index on 'Contrat', fields ['technicien']
        db.delete_index(u'contrat', ['technicien_id'])

        # Removing index on 'OeuvrePersonneRole', fields ['personne']
        db.delete_index(u'oeuvre_personne_role', ['personne_id'])

        # Removing index on 'VideoRecordPersonneRole', fields ['personne']
        db.delete_index(u'video_record_personne_role', ['personne_id'])

        # Removing index on 'NoteProgramme', fields ['technicien']
        db.delete_index(u'note_programme', ['technicien_id'])

        # Removing index on 'VideoVolumePersonneRole', fields ['personne']
        db.delete_index(u'video_volume_personne_role', ['personne_id'])

        # Removing index on 'VideoVolume', fields ['technicien']
        db.delete_index(u'video_volume', ['technicien_id'])

        # Removing index on 'VideoRecord', fields ['technicien']
        db.delete_index(u'video_record', ['technicien_id'])

        # Removing index on 'NotePersonneRoleEdit', fields ['personne']
        db.delete_index(u'note_personne_role_edit', ['personne_id'])


        # Renaming column for 'NotePersonneRoleEdit.personne' to match new field type.
        db.rename_column(u'note_personne_role_edit', 'personne_id', 'personne')
        # Changing field 'NotePersonneRoleEdit.personne'
        db.alter_column(u'note_personne_role_edit', 'personne', self.gf('django.db.models.fields.IntegerField')())

        # Renaming column for 'VideoRecord.technicien' to match new field type.
        db.rename_column(u'video_record', 'technicien_id', 'technicien')
        # Changing field 'VideoRecord.technicien'
        db.alter_column(u'video_record', 'technicien', self.gf('django.db.models.fields.IntegerField')())

        # Renaming column for 'VideoVolume.technicien' to match new field type.
        db.rename_column(u'video_volume', 'technicien_id', 'technicien')
        # Changing field 'VideoVolume.technicien'
        db.alter_column(u'video_volume', 'technicien', self.gf('django.db.models.fields.IntegerField')())

        # Renaming column for 'VideoVolumePersonneRole.personne' to match new field type.
        db.rename_column(u'video_volume_personne_role', 'personne_id', 'personne')
        # Changing field 'VideoVolumePersonneRole.personne'
        db.alter_column(u'video_volume_personne_role', 'personne', self.gf('django.db.models.fields.IntegerField')())

        # Renaming column for 'NoteProgramme.technicien' to match new field type.
        db.rename_column(u'note_programme', 'technicien_id', 'technicien')
        # Changing field 'NoteProgramme.technicien'
        db.alter_column(u'note_programme', 'technicien', self.gf('django.db.models.fields.IntegerField')())

        # Renaming column for 'VideoRecordPersonneRole.personne' to match new field type.
        db.rename_column(u'video_record_personne_role', 'personne_id', 'personne')
        # Changing field 'VideoRecordPersonneRole.personne'
        db.alter_column(u'video_record_personne_role', 'personne', self.gf('django.db.models.fields.IntegerField')())

        # Renaming column for 'OeuvrePersonneRole.personne' to match new field type.
        db.rename_column(u'oeuvre_personne_role', 'personne_id', 'personne')
        # Changing field 'OeuvrePersonneRole.personne'
        db.alter_column(u'oeuvre_personne_role', 'personne', self.gf('django.db.models.fields.IntegerField')())

        # Renaming column for 'Contrat.technicien' to match new field type.
        db.rename_column(u'contrat', 'technicien_id', 'technicien')
        # Changing field 'Contrat.technicien'
        db.alter_column(u'contrat', 'technicien', self.gf('django.db.models.fields.IntegerField')())
