...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'role_edit', (
            ('forme_canonique', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.RoleEdit'])),
            ('indice', self.gf('django.db.models.fields.IntegerField')()),
            ('supprime', self.gf('django.db.models.fields.IntegerField')()),
            ('intitule', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True)),
