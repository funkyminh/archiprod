...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Evenement.notes'
        db.add_column(u'evenement', 'notes',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Evenement.resume'
        db.add_column(u'evenement', 'resume',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Evenement.notes'
        db.delete_column(u'evenement', 'notes')

        # Deleting field 'Evenement.resume'
        db.delete_column(u'evenement', 'resume')
