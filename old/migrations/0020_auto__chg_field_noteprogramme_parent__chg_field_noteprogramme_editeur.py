...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'NoteProgramme.parent' to match new field type.
        db.rename_column(u'note_programme', 'parent', 'parent_id')
        # Changing field 'NoteProgramme.parent'
        db.alter_column(u'note_programme', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Evenement']))
        # Adding index on 'NoteProgramme', fields ['parent']
        db.create_index(u'note_programme', ['parent_id'])


        # Renaming column for 'NoteProgramme.editeur' to match new field type.
        db.rename_column(u'note_programme', 'editeur', 'editeur_id')
        # Changing field 'NoteProgramme.editeur'
        db.alter_column(u'note_programme', 'editeur_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Collectivite']))
        # Adding index on 'NoteProgramme', fields ['editeur']
        db.create_index(u'note_programme', ['editeur_id'])


    def backwards(self, orm):
        # Removing index on 'NoteProgramme', fields ['editeur']
        db.delete_index(u'note_programme', ['editeur_id'])

        # Removing index on 'NoteProgramme', fields ['parent']
        db.delete_index(u'note_programme', ['parent_id'])


        # Renaming column for 'NoteProgramme.parent' to match new field type.
        db.rename_column(u'note_programme', 'parent_id', 'parent')
        # Changing field 'NoteProgramme.parent'
        db.alter_column(u'note_programme', 'parent', self.gf('django.db.models.fields.IntegerField')())

        # Renaming column for 'NoteProgramme.editeur' to match new field type.
        db.rename_column(u'note_programme', 'editeur_id', 'editeur')
        # Changing field 'NoteProgramme.editeur'
        db.alter_column(u'note_programme', 'editeur', self.gf('django.db.models.fields.IntegerField')())
