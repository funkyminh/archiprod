...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Utilisateur.alt_login'
        db.alter_column(u'utilisateur', 'alt_login', self.gf('django.db.models.fields.CharField')(max_length=384, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Utilisateur.alt_login'
        raise RuntimeError("Cannot reverse this migration. 'Utilisateur.alt_login' and its values cannot be restored.")
