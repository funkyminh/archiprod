...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Evenement2.parent' to match new field type.
        db.rename_column(u'evenement2', 'parent', 'parent_id')
        # Changing field 'Evenement2.parent'
        db.alter_column(u'evenement2', 'parent_id', self.gf('mptt.fields.TreeForeignKey')(null=True, to=orm['old.Evenement2']))
        # Adding index on 'Evenement2', fields ['parent']
        db.create_index(u'evenement2', ['parent_id'])


    def backwards(self, orm):
        # Removing index on 'Evenement2', fields ['parent']
        db.delete_index(u'evenement2', ['parent_id'])


        # User chose to not deal with backwards NULL issues for 'Evenement2.parent'
        raise RuntimeError("Cannot reverse this migration. 'Evenement2.parent' and its values cannot be restored.")
