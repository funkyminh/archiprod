...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Evenement2'
        db.create_table(u'evenement2', (
            ('id', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
            ('supprime', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('intitule', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('sous_titre', self.gf('django.db.models.fields.CharField')(max_length=384, null=True, blank=True)),
            ('parent', self.gf('django.db.models.fields.IntegerField')()),
            ('type_evenement', self.gf('django.db.models.fields.IntegerField')()),
            ...
            ('flag_archive', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('flag_categorie', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('old', ['Evenement2'])


    def backwards(self, orm):
        # Deleting model 'Evenement2'
        db.delete_table(u'evenement2')
