...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'VolumeCollectivite.volume' to match new field type.
        db.rename_column(u'volume_collectivite', 'volume', 'volume_id')
        # Changing field 'VolumeCollectivite.volume'
        db.alter_column(u'volume_collectivite', 'volume_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Volume']))
        # Adding index on 'VolumeCollectivite', fields ['volume']
        db.create_index(u'volume_collectivite', ['volume_id'])


    def backwards(self, orm):
        # Removing index on 'VolumeCollectivite', fields ['volume']
        db.delete_index(u'volume_collectivite', ['volume_id'])


        # Renaming column for 'VolumeCollectivite.volume' to match new field type.
        db.rename_column(u'volume_collectivite', 'volume_id', 'volume')
        # Changing field 'VolumeCollectivite.volume'
        db.alter_column(u'volume_collectivite', 'volume', self.gf('django.db.models.fields.CharField')(max_length=30))
