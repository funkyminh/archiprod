...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contrat.notes'
        db.alter_column(u'contrat', 'notes', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Contrat.time_stamp'
        db.alter_column(u'contrat', 'time_stamp', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Contrat.type'
        db.alter_column(u'contrat', 'type', self.gf('django.db.models.fields.CharField')(max_length=1))

        # Changing field 'Contrat.mime_type'
        db.alter_column(u'contrat', 'mime_type', self.gf('django.db.models.fields.CharField')(max_length=765, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Contrat.notes'
        raise RuntimeError("Cannot reverse this migration. 'Contrat.notes' and its values cannot be restored.")

        # Changing field 'Contrat.time_stamp'
        db.alter_column(u'contrat', 'time_stamp', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Contrat.type'
        db.alter_column(u'contrat', 'type', self.gf('django.db.models.fields.IntegerField')())

        # User chose to not deal with backwards NULL issues for 'Contrat.mime_type'
        raise RuntimeError("Cannot reverse this migration. 'Contrat.mime_type' and its values cannot be restored.")
