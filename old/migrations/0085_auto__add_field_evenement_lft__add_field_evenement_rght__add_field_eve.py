...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Evenement.lft'
        db.add_column(u'evenement', 'lft',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Evenement.rght'
        db.add_column(u'evenement', 'rght',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Evenement.tree_id'
        db.add_column(u'evenement', 'tree_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Evenement.level'
        db.add_column(u'evenement', 'level',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)


        # Changing field 'Evenement.parent'
        db.alter_column(u'evenement', 'parent_id', self.gf('mptt.fields.TreeForeignKey')(null=True, to=orm['old.Evenement']))

    def backwards(self, orm):
        # Deleting field 'Evenement.lft'
        db.delete_column(u'evenement', 'lft')

        # Deleting field 'Evenement.rght'
        db.delete_column(u'evenement', 'rght')

        # Deleting field 'Evenement.tree_id'
        db.delete_column(u'evenement', 'tree_id')

        # Deleting field 'Evenement.level'
        db.delete_column(u'evenement', 'level')
