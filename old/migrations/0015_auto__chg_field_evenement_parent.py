...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Evenement.parent' to match new field type.
        db.rename_column(u'evenement', 'parent', 'parent_id')
        # Changing field 'Evenement.parent'
        db.alter_column(u'evenement', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Evenement']))
        # Adding index on 'Evenement', fields ['parent']
        db.create_index(u'evenement', ['parent_id'])


    def backwards(self, orm):
        # Removing index on 'Evenement', fields ['parent']
        db.delete_index(u'evenement', ['parent_id'])


        # Renaming column for 'Evenement.parent' to match new field type.
        db.rename_column(u'evenement', 'parent_id', 'parent')
        # Changing field 'Evenement.parent'
        db.alter_column(u'evenement', 'parent', self.gf('django.db.models.fields.IntegerField')())
