...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Personne.forme_canonique'
        db.alter_column(u'personne', 'forme_canonique_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Personne'], null=True))

        # Changing field 'Personne.doris_key'
        db.alter_column(u'personne', 'doris_key', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Personne.nom_na'
        db.alter_column(u'personne', 'nom_na', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'Personne.prenom_na'
        db.alter_column(u'personne', 'prenom_na', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'Personne.indice'
        db.alter_column(u'personne', 'indice', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Personne.brahms_key'
        db.alter_column(u'personne', 'brahms_key', self.gf('django.db.models.fields.CharField')(max_length=27, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Personne.forme_canonique'
        raise RuntimeError("Cannot reverse this migration. 'Personne.forme_canonique' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Personne.doris_key'
        raise RuntimeError("Cannot reverse this migration. 'Personne.doris_key' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Personne.nom_na'
        raise RuntimeError("Cannot reverse this migration. 'Personne.nom_na' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Personne.prenom_na'
        raise RuntimeError("Cannot reverse this migration. 'Personne.prenom_na' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Personne.indice'
        raise RuntimeError("Cannot reverse this migration. 'Personne.indice' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Personne.brahms_key'
        raise RuntimeError("Cannot reverse this migration. 'Personne.brahms_key' and its values cannot be restored.")
