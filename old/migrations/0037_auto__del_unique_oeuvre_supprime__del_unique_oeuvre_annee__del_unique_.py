...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        '''
        # Removing unique constraint on 'Role', fields ['supprime']
        db.delete_unique(u'role', ['supprime'])

        # Removing unique constraint on 'Utilisateur', fields ['prenom']
        db.delete_unique(u'utilisateur', ['prenom'])

        # Removing unique constraint on 'Utilisateur', fields ['nom']
        db.delete_unique(u'utilisateur', ['nom'])

        # Removing unique constraint on 'VideoSet', fields ['intitule']
        db.delete_unique(u'video_set', ['intitule'])

        # Removing unique constraint on 'VideoSet', fields ['supprime']
        db.delete_unique(u'video_set', ['supprime'])

        # Removing unique constraint on 'Contrat', fields ['intitule']
        db.delete_unique(u'contrat', ['intitule'])

        # Removing unique constraint on 'Contrat', fields ['supprime']
        db.delete_unique(u'contrat', ['supprime'])

        # Removing unique constraint on 'RoleEdit', fields ['supprime']
        db.delete_unique(u'role_edit', ['supprime'])

        # Removing unique constraint on 'NoteProgramme', fields ['intitule']
        db.delete_unique(u'note_programme', ['intitule'])

        # Removing unique constraint on 'NoteProgramme', fields ['supprime']
        db.delete_unique(u'note_programme', ['supprime'])

        # Removing unique constraint on 'Lieu', fields ['supprime']
        db.delete_unique(u'lieu', ['supprime'])

        # Removing unique constraint on 'Lieu', fields ['salle']
        db.delete_unique(u'lieu', ['salle'])

        # Removing unique constraint on 'Collectivite', fields ['supprime']
        db.delete_unique(u'collectivite', ['supprime'])

        # Removing unique constraint on 'TypeEvenement', fields ['supprime']
        db.delete_unique(u'type_evenement', ['supprime'])

        # Removing unique constraint on 'Oeuvre', fields ['annee']
        db.delete_unique(u'oeuvre', ['annee'])

        # Removing unique constraint on 'Oeuvre', fields ['supprime']
        db.delete_unique(u'oeuvre', ['supprime'])
        '''
        pass

    def backwards(self, orm):
        '''
        # Adding unique constraint on 'Oeuvre', fields ['supprime']
        db.create_unique(u'oeuvre', ['supprime'])

        # Adding unique constraint on 'Oeuvre', fields ['annee']
        db.create_unique(u'oeuvre', ['annee'])

        # Adding unique constraint on 'TypeEvenement', fields ['supprime']
        db.create_unique(u'type_evenement', ['supprime'])

        # Adding unique constraint on 'Collectivite', fields ['supprime']
        db.create_unique(u'collectivite', ['supprime'])

        # Adding unique constraint on 'Lieu', fields ['salle']
        db.create_unique(u'lieu', ['salle'])

        # Adding unique constraint on 'Lieu', fields ['supprime']
        db.create_unique(u'lieu', ['supprime'])

        # Adding unique constraint on 'NoteProgramme', fields ['supprime']
        db.create_unique(u'note_programme', ['supprime'])

        # Adding unique constraint on 'NoteProgramme', fields ['intitule']
        db.create_unique(u'note_programme', ['intitule'])

        # Adding unique constraint on 'RoleEdit', fields ['supprime']
        db.create_unique(u'role_edit', ['supprime'])

        # Adding unique constraint on 'Contrat', fields ['supprime']
        db.create_unique(u'contrat', ['supprime'])

        # Adding unique constraint on 'Contrat', fields ['intitule']
        db.create_unique(u'contrat', ['intitule'])

        # Adding unique constraint on 'VideoSet', fields ['supprime']
        db.create_unique(u'video_set', ['supprime'])

        # Adding unique constraint on 'VideoSet', fields ['intitule']
        db.create_unique(u'video_set', ['intitule'])

        # Adding unique constraint on 'Utilisateur', fields ['nom']
        db.create_unique(u'utilisateur', ['nom'])

        # Adding unique constraint on 'Utilisateur', fields ['prenom']
        db.create_unique(u'utilisateur', ['prenom'])

        # Adding unique constraint on 'Role', fields ['supprime']
        db.create_unique(u'role', ['supprime'])
        '''
