...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('old', ['Saison'])

        # Adding model 'TagEvenement'
        db.create_table(u'tag_evenement', (
            ('id', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
            ('intitule', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('sous_titre', self.gf('django.db.models.fields.CharField')(max_length=384, null=True, blank=True)),
            ('date_debut', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ...
        db.send_create_signal('old', ['TagEvenement'])


    def backwards(self, orm):
        # Deleting model 'Saison'
        db.delete_table(u'saison')

        # Deleting model 'TagEvenement'
        db.delete_table(u'tag_evenement')
