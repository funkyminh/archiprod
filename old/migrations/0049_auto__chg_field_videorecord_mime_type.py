...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VideoRecord.mime_type'
        db.alter_column(u'video_record', 'mime_type', self.gf('django.db.models.fields.CharField')(max_length=192, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'VideoRecord.mime_type'
        raise RuntimeError("Cannot reverse this migration. 'VideoRecord.mime_type' and its values cannot be restored.")
