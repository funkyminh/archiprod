...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NoteProgramme.sous_titre'
        db.add_column(u'note_programme', 'sous_titre',
        ...
        # Adding field 'NoteProgramme.saison'
        db.add_column(u'note_programme', 'saison',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Saison'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Volume.sous_titre'
        db.add_column(u'volume', 'sous_titre',
                      self.gf('django.db.models.fields.CharField')(max_length=384, null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Volume.type_evenement'
        db.add_column(u'volume', 'type_evenement',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.TypeEvenement'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Volume.saison'
        db.add_column(u'volume', 'saison',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Saison'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NoteProgramme.sous_titre'
        db.delete_column(u'note_programme', 'sous_titre')

        # Deleting field 'NoteProgramme.tag_evenement'
        db.delete_column(u'note_programme', 'tag_evenement_id')

        # Deleting field 'NoteProgramme.saison'
        db.delete_column(u'note_programme', 'saison_id')

        # Deleting field 'Volume.sous_titre'
        db.delete_column(u'volume', 'sous_titre')

        # Deleting field 'Volume.tag_evenement'
        db.delete_column(u'volume', 'tag_evenement_id')

        # Deleting field 'Volume.type_evenement'
        db.delete_column(u'volume', 'type_evenement_id')

        # Deleting field 'Volume.saison'
        db.delete_column(u'volume', 'saison_id')
    ...
    models = {
        ...
        'old.noteprogramme': {
            ...
            'sous_titre': ('django.db.models.fields.CharField', [], {'max_length': '384', 'null': 'True', 'blank': 'True'}),
            'supprime': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'tag_evenement': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['old.TagEvenement']", 'null': 'True', 'blank': 'True'}),
            'technicien': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['old.Utilisateur']"}),
            'time_stamp': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['old.TypeEvenement']", 'null': 'True', 'blank': 'True'})
        },
