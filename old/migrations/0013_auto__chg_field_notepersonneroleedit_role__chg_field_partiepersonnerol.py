...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'NotePersonneRoleEdit.role' to match new field type.
        db.rename_column(u'note_personne_role_edit', 'role', 'role_id')
        # Changing field 'NotePersonneRoleEdit.role'
        db.alter_column(u'note_personne_role_edit', 'role_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Role']))
        # Adding index on 'NotePersonneRoleEdit', fields ['role']
        db.create_index(u'note_personne_role_edit', ['role_id'])


        # Renaming column for 'PartiePersonneRole.role' to match new field type.
        db.rename_column(u'partie_personne_role', 'role', 'role_id')
        # Changing field 'PartiePersonneRole.role'
        db.alter_column(u'partie_personne_role', 'role_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Role']))
        # Adding index on 'PartiePersonneRole', fields ['role']
        db.create_index(u'partie_personne_role', ['role_id'])


        # Renaming column for 'VideoVolumePersonneRole.role' to match new field type.
        db.rename_column(u'video_volume_personne_role', 'role', 'role_id')
        # Changing field 'VideoVolumePersonneRole.role'
        db.alter_column(u'video_volume_personne_role', 'role_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Role']))
        # Adding index on 'VideoVolumePersonneRole', fields ['role']
        db.create_index(u'video_volume_personne_role', ['role_id'])


        # Renaming column for 'VideoRecordPersonneRole.role' to match new field type.
        db.rename_column(u'video_record_personne_role', 'role', 'role_id')
        # Changing field 'VideoRecordPersonneRole.role'
        db.alter_column(u'video_record_personne_role', 'role_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Role']))
        # Adding index on 'VideoRecordPersonneRole', fields ['role']
        db.create_index(u'video_record_personne_role', ['role_id'])


        # Renaming column for 'OeuvrePersonneRole.role' to match new field type.
        db.rename_column(u'oeuvre_personne_role', 'role', 'role_id')
        # Changing field 'OeuvrePersonneRole.role'
        db.alter_column(u'oeuvre_personne_role', 'role_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Role']))
        # Adding index on 'OeuvrePersonneRole', fields ['role']
        db.create_index(u'oeuvre_personne_role', ['role_id'])


    def backwards(self, orm):
        # Removing index on 'OeuvrePersonneRole', fields ['role']
        db.delete_index(u'oeuvre_personne_role', ['role_id'])

        # Removing index on 'VideoRecordPersonneRole', fields ['role']
        db.delete_index(u'video_record_personne_role', ['role_id'])

        # Removing index on 'VideoVolumePersonneRole', fields ['role']
        db.delete_index(u'video_volume_personne_role', ['role_id'])

        # Removing index on 'PartiePersonneRole', fields ['role']
        db.delete_index(u'partie_personne_role', ['role_id'])

        # Removing index on 'NotePersonneRoleEdit', fields ['role']
        db.delete_index(u'note_personne_role_edit', ['role_id'])


        # Renaming column for 'NotePersonneRoleEdit.role' to match new field type.
        db.rename_column(u'note_personne_role_edit', 'role_id', 'role')
        # Changing field 'NotePersonneRoleEdit.role'
        db.alter_column(u'note_personne_role_edit', 'role', self.gf('django.db.models.fields.IntegerField')())

        # Renaming column for 'PartiePersonneRole.role' to match new field type.
        db.rename_column(u'partie_personne_role', 'role_id', 'role')
        # Changing field 'PartiePersonneRole.role'
        db.alter_column(u'partie_personne_role', 'role', self.gf('django.db.models.fields.IntegerField')())

        # Renaming column for 'VideoVolumePersonneRole.role' to match new field type.
        db.rename_column(u'video_volume_personne_role', 'role_id', 'role')
        # Changing field 'VideoVolumePersonneRole.role'
        db.alter_column(u'video_volume_personne_role', 'role', self.gf('django.db.models.fields.IntegerField')())

        # Renaming column for 'VideoRecordPersonneRole.role' to match new field type.
        db.rename_column(u'video_record_personne_role', 'role_id', 'role')
        # Changing field 'VideoRecordPersonneRole.role'
        db.alter_column(u'video_record_personne_role', 'role', self.gf('django.db.models.fields.IntegerField')())

        # Renaming column for 'OeuvrePersonneRole.role' to match new field type.
        db.rename_column(u'oeuvre_personne_role', 'role_id', 'role')
        # Changing field 'OeuvrePersonneRole.role'
        db.alter_column(u'oeuvre_personne_role', 'role', self.gf('django.db.models.fields.IntegerField')())
