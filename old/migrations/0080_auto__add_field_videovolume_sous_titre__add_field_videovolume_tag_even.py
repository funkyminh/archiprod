...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VideoVolume.sous_titre'
        db.add_column(u'video_volume', 'sous_titre',
        ...
        # Adding field 'VideoVolume.type_evenement'
        db.add_column(u'video_volume', 'type_evenement',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.TypeEvenement'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'VideoVolume.saison'
        db.add_column(u'video_volume', 'saison',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Saison'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VideoVolume.sous_titre'
        db.delete_column(u'video_volume', 'sous_titre')

        # Deleting field 'VideoVolume.tag_evenement'
        db.delete_column(u'video_volume', 'tag_evenement_id')

        # Deleting field 'VideoVolume.type_evenement'
        db.delete_column(u'video_volume', 'type_evenement_id')

        # Deleting field 'VideoVolume.saison'
        db.delete_column(u'video_volume', 'saison_id')
