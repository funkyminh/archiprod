...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VideoSet.sous_titre'
        db.alter_column(u'video_set', 'sous_titre', self.gf('django.db.models.fields.CharField')(max_length=384, null=True))

        # Changing field 'VideoSet.resume'
        db.alter_column(u'video_set', 'resume', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'VideoSet.notes'
        db.alter_column(u'video_set', 'notes', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'VideoSet.time_stamp'
        db.alter_column(u'video_set', 'time_stamp', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):
        '''
        # User chose to not deal with backwards NULL issues for 'VideoSet.sous_titre'
        raise RuntimeError("Cannot reverse this migration. 'VideoSet.sous_titre' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'VideoSet.resume'
        raise RuntimeError("Cannot reverse this migration. 'VideoSet.resume' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'VideoSet.notes'
        raise RuntimeError("Cannot reverse this migration. 'VideoSet.notes' and its values cannot be restored.")

        # Changing field 'VideoSet.time_stamp'
        db.alter_column(u'video_set', 'time_stamp', self.gf('django.db.models.fields.DateTimeField')())
        '''
        pass
    models = {
        'old.collectivite': {
        ...
        'old.videoset': {
            ...
            'supprime': ('django.db.models.fields.IntegerField', [], {'default': '0', 'unique': 'True'}),
            'time_stamp': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        'old.videovolume': {
