...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        cursor.execute("INSERT INTO `evenement2` (id,supprime,intitule,sous_titre,parent,type_evenement,date_debut,date_fin,time_stamp,flag_archive,flag_categorie) SELECT id,supprime,intitule,sous_titre,parent,type,date_debut,date_fin,time_stamp,0,0 FROM evenement_dump")
