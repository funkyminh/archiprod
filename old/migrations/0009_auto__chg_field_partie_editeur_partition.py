...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Partie.editeur_partition' to match new field type.
        db.rename_column(u'partie', 'editeur_partition', 'editeur_partition_id')
        # Changing field 'Partie.editeur_partition'
        db.alter_column(u'partie', 'editeur_partition_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Collectivite']))
        # Adding index on 'Partie', fields ['editeur_partition']
        db.create_index(u'partie', ['editeur_partition_id'])


    def backwards(self, orm):
        # Removing index on 'Partie', fields ['editeur_partition']
        db.delete_index(u'partie', ['editeur_partition_id'])


        # Renaming column for 'Partie.editeur_partition' to match new field type.
        db.rename_column(u'partie', 'editeur_partition_id', 'editeur_partition')
        # Changing field 'Partie.editeur_partition'
        db.alter_column(u'partie', 'editeur_partition', self.gf('django.db.models.fields.IntegerField')())
