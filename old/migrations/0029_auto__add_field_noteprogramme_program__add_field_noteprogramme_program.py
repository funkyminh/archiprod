...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NoteProgramme.program'
        db.add_column(u'note_programme', 'program',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'NoteProgramme.program_ext'
        db.add_column(u'note_programme', 'program_ext',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'NoteProgramme.program_int'
        db.add_column(u'note_programme', 'program_int',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Contrat.contract'
        db.add_column(u'contrat', 'contract',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NoteProgramme.program'
        db.delete_column(u'note_programme', 'program')

        # Deleting field 'NoteProgramme.program_ext'
        db.delete_column(u'note_programme', 'program_ext')

        # Deleting field 'NoteProgramme.program_int'
        db.delete_column(u'note_programme', 'program_int')

        # Deleting field 'Contrat.contract'
        db.delete_column(u'contrat', 'contract')
