...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'VideoVolume.tag_evenement'
        db.delete_column(u'video_volume', 'tag_evenement_id')

        # Adding M2M table for field tag_evenements on 'VideoVolume'
        db.create_table(u'video_volume_tag_evenements', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('videovolume', models.ForeignKey(orm['old.videovolume'], null=False)),
            ('tagevenement', models.ForeignKey(orm['old.tagevenement'], null=False))
        ))
        db.create_unique(u'video_volume_tag_evenements', ['videovolume_id', 'tagevenement_id'])

        # Deleting field 'NoteProgramme.tag_evenement'
        db.delete_column(u'note_programme', 'tag_evenement_id')

        # Adding M2M table for field tag_evenements on 'NoteProgramme'
        db.create_table(u'note_programme_tag_evenements', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('noteprogramme', models.ForeignKey(orm['old.noteprogramme'], null=False)),
            ('tagevenement', models.ForeignKey(orm['old.tagevenement'], null=False))
        ))
        db.create_unique(u'note_programme_tag_evenements', ['noteprogramme_id', 'tagevenement_id'])

        # Deleting field 'Volume.tag_evenement'
        db.delete_column(u'volume', 'tag_evenement_id')

        # Adding M2M table for field tag_evenements on 'Volume'
        db.create_table(u'volume_tag_evenements', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('volume', models.ForeignKey(orm['old.volume'], null=False)),
            ('tagevenement', models.ForeignKey(orm['old.tagevenement'], null=False))
        ))
        db.create_unique(u'volume_tag_evenements', ['volume_id', 'tagevenement_id'])


    def backwards(self, orm):
        # Adding field 'VideoVolume.tag_evenement'
        db.add_column(u'video_volume', 'tag_evenement',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.TagEvenement'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field tag_evenements on 'VideoVolume'
        db.delete_table('video_volume_tag_evenements')

        # Adding field 'NoteProgramme.tag_evenement'
        db.add_column(u'note_programme', 'tag_evenement',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.TagEvenement'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field tag_evenements on 'NoteProgramme'
        db.delete_table('note_programme_tag_evenements')

        # Adding field 'Volume.tag_evenement'
        db.add_column(u'volume', 'tag_evenement',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.TagEvenement'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field tag_evenements on 'Volume'
        db.delete_table('volume_tag_evenements')
