...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Collectivite.forme_canonique' to match new field type.
        db.rename_column(u'collectivite', 'forme_canonique', 'forme_canonique_id')
        # Changing field 'Collectivite.forme_canonique'
        db.alter_column(u'collectivite', 'forme_canonique_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Collectivite'], null=True))
        # Adding index on 'Collectivite', fields ['forme_canonique']
        db.create_index(u'collectivite', ['forme_canonique_id'])


        # Changing field 'Collectivite.indice'
        db.alter_column(u'collectivite', 'indice', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):
        # Removing index on 'Collectivite', fields ['forme_canonique']
        db.delete_index(u'collectivite', ['forme_canonique_id'])


        # User chose to not deal with backwards NULL issues for 'Collectivite.forme_canonique'
        raise RuntimeError("Cannot reverse this migration. 'Collectivite.forme_canonique' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Collectivite.indice'
        raise RuntimeError("Cannot reverse this migration. 'Collectivite.indice' and its values cannot be restored.")
