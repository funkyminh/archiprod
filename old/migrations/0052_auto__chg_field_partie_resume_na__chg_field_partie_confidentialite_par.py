...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Partie.resume_na'
        db.alter_column(u'partie', 'resume_na', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Partie.confidentialite_partie'
        db.alter_column(u'partie', 'confidentialite_partie', self.gf('django.db.models.fields.CharField')(max_length=1))

        # Changing field 'Partie.partype'
        db.alter_column(u'partie', 'partype', self.gf('django.db.models.fields.CharField')(max_length=1))

        # Changing field 'Partie.titre'
        db.alter_column(u'partie', 'titre', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Partie.resume'
        db.alter_column(u'partie', 'resume', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Partie.duree'
        db.alter_column(u'partie', 'duree', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Partie.time_stamp'
        db.alter_column(u'partie', 'time_stamp', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Partie.oeuvre'
        db.alter_column(u'partie', 'oeuvre_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Oeuvre'], null=True))

        # Changing field 'Partie.titre_na'
        db.alter_column(u'partie', 'titre_na', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Partie.brahms_key'
        db.alter_column(u'partie', 'brahms_key', self.gf('django.db.models.fields.CharField')(max_length=27, null=True))

        # Changing field 'Partie.notes'
        db.alter_column(u'partie', 'notes', self.gf('django.db.models.fields.CharField')(max_length=765, null=True))

        # Changing field 'Partie.editeur_partition'
        db.alter_column(u'partie', 'editeur_partition_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Collectivite'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Partie.resume_na'
        raise RuntimeError("Cannot reverse this migration. 'Partie.resume_na' and its values cannot be restored.")

        # Changing field 'Partie.confidentialite_partie'
        db.alter_column(u'partie', 'confidentialite_partie', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Partie.partype'
        db.alter_column(u'partie', 'partype', self.gf('django.db.models.fields.IntegerField')())

        # User chose to not deal with backwards NULL issues for 'Partie.titre'
        raise RuntimeError("Cannot reverse this migration. 'Partie.titre' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Partie.resume'
        raise RuntimeError("Cannot reverse this migration. 'Partie.resume' and its values cannot be restored.")

        # Changing field 'Partie.duree'
        db.alter_column(u'partie', 'duree', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Partie.time_stamp'
        db.alter_column(u'partie', 'time_stamp', self.gf('django.db.models.fields.DateTimeField')())

        # User chose to not deal with backwards NULL issues for 'Partie.oeuvre'
        raise RuntimeError("Cannot reverse this migration. 'Partie.oeuvre' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Partie.titre_na'
        raise RuntimeError("Cannot reverse this migration. 'Partie.titre_na' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Partie.brahms_key'
        raise RuntimeError("Cannot reverse this migration. 'Partie.brahms_key' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Partie.notes'
        raise RuntimeError("Cannot reverse this migration. 'Partie.notes' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Partie.editeur_partition'
        raise RuntimeError("Cannot reverse this migration. 'Partie.editeur_partition' and its values cannot be restored.")
    ...
    models = {
        ...
        'old.partie': {
            ...
            'resume_na': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'seq': ('django.db.models.fields.IntegerField', [], {}),
            'supprime': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'time_stamp': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'titre': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'titre_na': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
