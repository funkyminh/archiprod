...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Partie.volume'
        db.add_column(u'partie', 'volume',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Volume'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Partie.volume'
        db.delete_column(u'partie', 'volume_id')
