...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Evenement2.lft'
        db.add_column(u'evenement2', 'lft',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Evenement2.rght'
        db.add_column(u'evenement2', 'rght',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Evenement2.tree_id'
        db.add_column(u'evenement2', 'tree_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Evenement2.level'
        db.add_column(u'evenement2', 'level',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Evenement2.lft'
        db.delete_column(u'evenement2', 'lft')

        # Deleting field 'Evenement2.rght'
        db.delete_column(u'evenement2', 'rght')

        # Deleting field 'Evenement2.tree_id'
        db.delete_column(u'evenement2', 'tree_id')

        # Deleting field 'Evenement2.level'
        db.delete_column(u'evenement2', 'level')
