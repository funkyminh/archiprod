...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Evenement.sous_titre'
        db.alter_column(u'evenement', 'sous_titre', self.gf('django.db.models.fields.CharField')(max_length=384, null=True))

        # Changing field 'Evenement.parent'
        db.alter_column(u'evenement', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Evenement'], null=True))

        # Changing field 'Evenement.event_children'
        db.alter_column(u'evenement', 'event_children', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Evenement.video_children'
        db.alter_column(u'evenement', 'video_children', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Evenement.audio_children'
        db.alter_column(u'evenement', 'audio_children', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Evenement.pdf_children'
        db.alter_column(u'evenement', 'pdf_children', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Evenement.time_stamp'
        db.alter_column(u'evenement', 'time_stamp', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Renaming column for 'Evenement.type' to match new field type.
        db.rename_column(u'evenement', 'type', 'type_id')
        # Changing field 'Evenement.type'
        db.alter_column(u'evenement', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.TypeEvenement'], null=True))
        # Adding index on 'Evenement', fields ['type']
        db.create_index(u'evenement', ['type_id'])


    def backwards(self, orm):
        # Removing index on 'Evenement', fields ['type']
        db.delete_index(u'evenement', ['type_id'])


        # User chose to not deal with backwards NULL issues for 'Evenement.sous_titre'
        raise RuntimeError("Cannot reverse this migration. 'Evenement.sous_titre' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Evenement.parent'
        raise RuntimeError("Cannot reverse this migration. 'Evenement.parent' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Evenement.event_children'
        raise RuntimeError("Cannot reverse this migration. 'Evenement.event_children' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Evenement.video_children'
        raise RuntimeError("Cannot reverse this migration. 'Evenement.video_children' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Evenement.audio_children'
        raise RuntimeError("Cannot reverse this migration. 'Evenement.audio_children' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Evenement.pdf_children'
        raise RuntimeError("Cannot reverse this migration. 'Evenement.pdf_children' and its values cannot be restored.")

        # Changing field 'Evenement.time_stamp'
        db.alter_column(u'evenement', 'time_stamp', self.gf('django.db.models.fields.DateTimeField')())

        # User chose to not deal with backwards NULL issues for 'Evenement.type'
        raise RuntimeError("Cannot reverse this migration. 'Evenement.type' and its values cannot be restored.")
