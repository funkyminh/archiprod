...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'NoteProgramme.type'
        db.delete_column(u'note_programme', 'type_id')

        # Adding field 'NoteProgramme.type_evenement'
        db.add_column(u'note_programme', 'type_evenement',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.TypeEvenement'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'NoteProgramme.type'
        db.add_column(u'note_programme', 'type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.TypeEvenement'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'NoteProgramme.type_evenement'
        db.delete_column(u'note_programme', 'type_evenement_id')
