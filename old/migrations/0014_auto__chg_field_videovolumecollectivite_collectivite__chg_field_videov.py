...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'VideoVolumeCollectivite.collectivite' to match new field type.
        db.rename_column(u'video_volume_collectivite', 'collectivite', 'collectivite_id')
        # Changing field 'VideoVolumeCollectivite.collectivite'
        db.alter_column(u'video_volume_collectivite', 'collectivite_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Collectivite']))
        # Adding index on 'VideoVolumeCollectivite', fields ['collectivite']
        db.create_index(u'video_volume_collectivite', ['collectivite_id'])


        # Renaming column for 'VideoVolume.lieu' to match new field type.
        db.rename_column(u'video_volume', 'lieu', 'lieu_id')
        # Changing field 'VideoVolume.lieu'
        db.alter_column(u'video_volume', 'lieu_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Lieu']))
        # Adding index on 'VideoVolume', fields ['lieu']
        db.create_index(u'video_volume', ['lieu_id'])


        # Renaming column for 'OeuvrePersonneRole.oeuvre' to match new field type.
        db.rename_column(u'oeuvre_personne_role', 'oeuvre', 'oeuvre_id')
        # Changing field 'OeuvrePersonneRole.oeuvre'
        db.alter_column(u'oeuvre_personne_role', 'oeuvre_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Oeuvre']))
        # Adding index on 'OeuvrePersonneRole', fields ['oeuvre']
        db.create_index(u'oeuvre_personne_role', ['oeuvre_id'])


        # Renaming column for 'VideoRecordCollectivite.collectivite' to match new field type.
        db.rename_column(u'video_record_collectivite', 'collectivite', 'collectivite_id')
        # Changing field 'VideoRecordCollectivite.collectivite'
        db.alter_column(u'video_record_collectivite', 'collectivite_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Collectivite']))
        # Adding index on 'VideoRecordCollectivite', fields ['collectivite']
        db.create_index(u'video_record_collectivite', ['collectivite_id'])


    def backwards(self, orm):
        # Removing index on 'VideoRecordCollectivite', fields ['collectivite']
        db.delete_index(u'video_record_collectivite', ['collectivite_id'])

        # Removing index on 'OeuvrePersonneRole', fields ['oeuvre']
        db.delete_index(u'oeuvre_personne_role', ['oeuvre_id'])

        # Removing index on 'VideoVolume', fields ['lieu']
        db.delete_index(u'video_volume', ['lieu_id'])

        # Removing index on 'VideoVolumeCollectivite', fields ['collectivite']
        db.delete_index(u'video_volume_collectivite', ['collectivite_id'])


        # Renaming column for 'VideoVolumeCollectivite.collectivite' to match new field type.
        db.rename_column(u'video_volume_collectivite', 'collectivite_id', 'collectivite')
        # Changing field 'VideoVolumeCollectivite.collectivite'
        db.alter_column(u'video_volume_collectivite', 'collectivite', self.gf('django.db.models.fields.IntegerField')())

        # Renaming column for 'VideoVolume.lieu' to match new field type.
        db.rename_column(u'video_volume', 'lieu_id', 'lieu')
        # Changing field 'VideoVolume.lieu'
        db.alter_column(u'video_volume', 'lieu', self.gf('django.db.models.fields.IntegerField')())

        # Renaming column for 'OeuvrePersonneRole.oeuvre' to match new field type.
        db.rename_column(u'oeuvre_personne_role', 'oeuvre_id', 'oeuvre')
        # Changing field 'OeuvrePersonneRole.oeuvre'
        db.alter_column(u'oeuvre_personne_role', 'oeuvre', self.gf('django.db.models.fields.IntegerField')())

        # Renaming column for 'VideoRecordCollectivite.collectivite' to match new field type.
        db.rename_column(u'video_record_collectivite', 'collectivite_id', 'collectivite')
        # Changing field 'VideoRecordCollectivite.collectivite'
        db.alter_column(u'video_record_collectivite', 'collectivite', self.gf('django.db.models.fields.IntegerField')())
