...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NoteProgramme.notes'
        db.alter_column(u'note_programme', 'notes', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'NoteProgramme.etat_note'
        db.alter_column(u'note_programme', 'etat_note', self.gf('django.db.models.fields.CharField')(max_length=1))

        # Renaming column for 'NoteProgramme.type' to match new field type.
        db.rename_column(u'note_programme', 'type', 'type_id')
        # Changing field 'NoteProgramme.type'
        db.alter_column(u'note_programme', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.TypeEvenement'], null=True))
        # Adding index on 'NoteProgramme', fields ['type']
        db.create_index(u'note_programme', ['type_id'])


        # Changing field 'NoteProgramme.editeur'
        db.alter_column(u'note_programme', 'editeur_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Collectivite'], null=True))

        # Changing field 'NoteProgramme.time_stamp'
        db.alter_column(u'note_programme', 'time_stamp', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'NoteProgramme.confidentialite'
        db.alter_column(u'note_programme', 'confidentialite', self.gf('django.db.models.fields.CharField')(max_length=1))

        # Changing field 'NoteProgramme.mime_type'
        db.alter_column(u'note_programme', 'mime_type', self.gf('django.db.models.fields.CharField')(max_length=765, null=True))

    def backwards(self, orm):
        # Removing index on 'NoteProgramme', fields ['type']
        db.delete_index(u'note_programme', ['type_id'])


        # User chose to not deal with backwards NULL issues for 'NoteProgramme.notes'
        raise RuntimeError("Cannot reverse this migration. 'NoteProgramme.notes' and its values cannot be restored.")

        # Changing field 'NoteProgramme.etat_note'
        db.alter_column(u'note_programme', 'etat_note', self.gf('django.db.models.fields.IntegerField')())

        # User chose to not deal with backwards NULL issues for 'NoteProgramme.type'
        raise RuntimeError("Cannot reverse this migration. 'NoteProgramme.type' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'NoteProgramme.editeur'
        raise RuntimeError("Cannot reverse this migration. 'NoteProgramme.editeur' and its values cannot be restored.")

        # Changing field 'NoteProgramme.time_stamp'
        db.alter_column(u'note_programme', 'time_stamp', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'NoteProgramme.confidentialite'
        db.alter_column(u'note_programme', 'confidentialite', self.gf('django.db.models.fields.IntegerField')())

        # User chose to not deal with backwards NULL issues for 'NoteProgramme.mime_type'
        raise RuntimeError("Cannot reverse this migration. 'NoteProgramme.mime_type' and its values cannot be restored.")
