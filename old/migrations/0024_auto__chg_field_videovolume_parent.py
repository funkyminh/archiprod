...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'VideoVolume.parent' to match new field type.
        db.rename_column(u'video_volume', 'parent', 'parent_id')
        # Changing field 'VideoVolume.parent'
        db.alter_column(u'video_volume', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Evenement']))
        # Adding index on 'VideoVolume', fields ['parent']
        db.create_index(u'video_volume', ['parent_id'])


    def backwards(self, orm):
        # Removing index on 'VideoVolume', fields ['parent']
        db.delete_index(u'video_volume', ['parent_id'])


        # Renaming column for 'VideoVolume.parent' to match new field type.
        db.rename_column(u'video_volume', 'parent_id', 'parent')
        # Changing field 'VideoVolume.parent'
        db.alter_column(u'video_volume', 'parent', self.gf('django.db.models.fields.IntegerField')())
