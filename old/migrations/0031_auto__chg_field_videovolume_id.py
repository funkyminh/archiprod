...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VideoVolume.id'
        db.alter_column(u'video_volume', 'id', self.gf('django.db.models.fields.CharField')(max_length=12, primary_key=True))

    def backwards(self, orm):

        # Changing field 'VideoVolume.id'
        db.alter_column(u'video_volume', 'id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True))
