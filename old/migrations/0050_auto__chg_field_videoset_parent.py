...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'video_set', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.VideoSet'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'VideoSet.parent'
        raise RuntimeError("Cannot reverse this migration. 'VideoSet.parent' and its values cannot be restored.")
