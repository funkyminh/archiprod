...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Volume.notes_na'
        db.delete_column(u'volume', 'notes_na')

        # Deleting field 'Volume.intitule_na'
        db.delete_column(u'volume', 'intitule_na')

        # Deleting field 'Personne.nom_na'
        db.delete_column(u'personne', 'nom_na')

        # Deleting field 'Personne.prenom_na'
        db.delete_column(u'personne', 'prenom_na')

        # Deleting field 'Partie.resume_na'
        db.delete_column(u'partie', 'resume_na')

        # Deleting field 'Partie.titre_na'
        db.delete_column(u'partie', 'titre_na')


    def backwards(self, orm):
        # Adding field 'Volume.notes_na'
        db.add_column(u'volume', 'notes_na',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Volume.intitule_na'
        db.add_column(u'volume', 'intitule_na',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Personne.nom_na'
        db.add_column(u'personne', 'nom_na',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Personne.prenom_na'
        db.add_column(u'personne', 'prenom_na',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Partie.resume_na'
        db.add_column(u'partie', 'resume_na',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Partie.titre_na'
        db.add_column(u'partie', 'titre_na',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
