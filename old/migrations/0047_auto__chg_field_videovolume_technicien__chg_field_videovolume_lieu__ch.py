...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'video_volume', 'lieu_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Lieu'], null=True))

        # Changing field 'VideoVolume.type'
        db.alter_column(u'video_volume', 'type', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'VideoVolume.technicien'
        raise RuntimeError("Cannot reverse this migration. 'VideoVolume.technicien' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'VideoVolume.lieu'
        raise RuntimeError("Cannot reverse this migration. 'VideoVolume.lieu' and its values cannot be restored.")

        # Changing field 'VideoVolume.type'
        db.alter_column(u'video_volume', 'type', self.gf('django.db.models.fields.IntegerField')(null=True))
