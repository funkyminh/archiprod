...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Oeuvre.annee'
        db.alter_column(u'oeuvre', 'annee', self.gf('django.db.models.fields.CharField')(max_length=12, null=True))

        # Changing field 'Oeuvre.sous_titre'
        db.alter_column(u'oeuvre', 'sous_titre', self.gf('django.db.models.fields.CharField')(max_length=384, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Oeuvre.annee'
        raise RuntimeError("Cannot reverse this migration. 'Oeuvre.annee' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Oeuvre.sous_titre'
        raise RuntimeError("Cannot reverse this migration. 'Oeuvre.sous_titre' and its values cannot be restored.")
