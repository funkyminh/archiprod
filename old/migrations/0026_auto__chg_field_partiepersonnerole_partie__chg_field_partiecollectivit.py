...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'PartiePersonneRole.partie' to match new field type.
        db.rename_column(u'partie_personne_role', 'partie', 'partie_id')
        # Changing field 'PartiePersonneRole.partie'
        db.alter_column(u'partie_personne_role', 'partie_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Partie']))
        # Adding index on 'PartiePersonneRole', fields ['partie']
        db.create_index(u'partie_personne_role', ['partie_id'])


        # Renaming column for 'PartieCollectivite.partie' to match new field type.
        db.rename_column(u'partie_collectivite', 'partie', 'partie_id')
        # Changing field 'PartieCollectivite.partie'
        db.alter_column(u'partie_collectivite', 'partie_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Partie']))
        # Adding index on 'PartieCollectivite', fields ['partie']
        db.create_index(u'partie_collectivite', ['partie_id'])


    def backwards(self, orm):
        # Removing index on 'PartieCollectivite', fields ['partie']
        db.delete_index(u'partie_collectivite', ['partie_id'])

        # Removing index on 'PartiePersonneRole', fields ['partie']
        db.delete_index(u'partie_personne_role', ['partie_id'])


        # Renaming column for 'PartiePersonneRole.partie' to match new field type.
        db.rename_column(u'partie_personne_role', 'partie_id', 'partie')
        # Changing field 'PartiePersonneRole.partie'
        db.alter_column(u'partie_personne_role', 'partie', self.gf('django.db.models.fields.CharField')(max_length=45))

        # Renaming column for 'PartieCollectivite.partie' to match new field type.
        db.rename_column(u'partie_collectivite', 'partie_id', 'partie')
        # Changing field 'PartieCollectivite.partie'
        db.alter_column(u'partie_collectivite', 'partie', self.gf('django.db.models.fields.CharField')(max_length=45))
