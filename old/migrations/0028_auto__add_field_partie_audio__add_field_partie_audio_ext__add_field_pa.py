...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Partie.audio'
        db.add_column(u'partie', 'audio',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Partie.audio_ext'
        db.add_column(u'partie', 'audio_ext',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Partie.audio_int'
        db.add_column(u'partie', 'audio_int',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Partie.audio'
        db.delete_column(u'partie', 'audio')

        # Deleting field 'Partie.audio_ext'
        db.delete_column(u'partie', 'audio_ext')

        # Deleting field 'Partie.audio_int'
        db.delete_column(u'partie', 'audio_int')
