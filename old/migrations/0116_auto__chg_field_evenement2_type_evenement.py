...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Evenement2.type_evenement' to match new field type.
        db.rename_column(u'evenement2', 'type_evenement', 'type_evenement_id')
        # Changing field 'Evenement2.type_evenement'
        db.alter_column(u'evenement2', 'type_evenement_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.TypeEvenement'], null=True))
        # Adding index on 'Evenement2', fields ['type_evenement']
        db.create_index(u'evenement2', ['type_evenement_id'])


    def backwards(self, orm):
        # Removing index on 'Evenement2', fields ['type_evenement']
        db.delete_index(u'evenement2', ['type_evenement_id'])


        # User chose to not deal with backwards NULL issues for 'Evenement2.type_evenement'
        raise RuntimeError("Cannot reverse this migration. 'Evenement2.type_evenement' and its values cannot be restored.")
