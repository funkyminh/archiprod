...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        '''
        insert ignore into tag_evenement
select id, intitule, sous_titre, date_debut, date_fin, time_stamp from evenement
where level > 1 
and flag_archive != 1
        '''
        from django.db import connection, transaction
        cursor1 = connection.cursor()
        cursor1.execute("insert ignore into tag_evenement select id, intitule, sous_titre, date_debut, date_fin, time_stamp from evenement where level > 1 and flag_archive != 1")
