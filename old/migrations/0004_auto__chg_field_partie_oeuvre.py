...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Partie.oeuvre' to match new field type.
        db.rename_column(u'partie', 'oeuvre', 'oeuvre_id')
        # Changing field 'Partie.oeuvre'
        db.alter_column(u'partie', 'oeuvre_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Oeuvre']))
        # Adding index on 'Partie', fields ['oeuvre']
        db.create_index(u'partie', ['oeuvre_id'])


    def backwards(self, orm):
        # Removing index on 'Partie', fields ['oeuvre']
        db.delete_index(u'partie', ['oeuvre_id'])


        # Renaming column for 'Partie.oeuvre' to match new field type.
        db.rename_column(u'partie', 'oeuvre_id', 'oeuvre')
        # Changing field 'Partie.oeuvre'
        db.alter_column(u'partie', 'oeuvre', self.gf('django.db.models.fields.IntegerField')())
