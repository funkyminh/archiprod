...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'RoleEdit.forme_canonique' to match new field type.
        db.rename_column(u'role_edit', 'forme_canonique', 'forme_canonique_id')
        # Changing field 'RoleEdit.forme_canonique'
        db.alter_column(u'role_edit', 'forme_canonique_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.RoleEdit']))
        # Adding index on 'RoleEdit', fields ['forme_canonique']
        db.create_index(u'role_edit', ['forme_canonique_id'])


        # Renaming column for 'Personne.forme_canonique' to match new field type.
        db.rename_column(u'personne', 'forme_canonique', 'forme_canonique_id')
        # Changing field 'Personne.forme_canonique'
        db.alter_column(u'personne', 'forme_canonique_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Personne']))
        # Adding index on 'Personne', fields ['forme_canonique']
        db.create_index(u'personne', ['forme_canonique_id'])


        # Renaming column for 'Role.forme_canonique' to match new field type.
        db.rename_column(u'role', 'forme_canonique', 'forme_canonique_id')
        # Changing field 'Role.forme_canonique'
        db.alter_column(u'role', 'forme_canonique_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Role']))
        # Adding index on 'Role', fields ['forme_canonique']
        db.create_index(u'role', ['forme_canonique_id'])


    def backwards(self, orm):
        # Removing index on 'Role', fields ['forme_canonique']
        db.delete_index(u'role', ['forme_canonique_id'])

        # Removing index on 'Personne', fields ['forme_canonique']
        db.delete_index(u'personne', ['forme_canonique_id'])

        # Removing index on 'RoleEdit', fields ['forme_canonique']
        db.delete_index(u'role_edit', ['forme_canonique_id'])


        # Renaming column for 'RoleEdit.forme_canonique' to match new field type.
        db.rename_column(u'role_edit', 'forme_canonique_id', 'forme_canonique')
        # Changing field 'RoleEdit.forme_canonique'
        db.alter_column(u'role_edit', 'forme_canonique', self.gf('django.db.models.fields.IntegerField')())

        # Renaming column for 'Personne.forme_canonique' to match new field type.
        db.rename_column(u'personne', 'forme_canonique_id', 'forme_canonique')
        # Changing field 'Personne.forme_canonique'
        db.alter_column(u'personne', 'forme_canonique', self.gf('django.db.models.fields.IntegerField')())

        # Renaming column for 'Role.forme_canonique' to match new field type.
        db.rename_column(u'role', 'forme_canonique_id', 'forme_canonique')
        # Changing field 'Role.forme_canonique'
        db.alter_column(u'role', 'forme_canonique', self.gf('django.db.models.fields.IntegerField')())
