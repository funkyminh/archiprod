...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'VideoRecordPersonneRole.video_record' to match new field type.
        db.rename_column(u'video_record_personne_role', 'video_record', 'video_record_id')
        # Changing field 'VideoRecordPersonneRole.video_record'
        db.alter_column(u'video_record_personne_role', 'video_record_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.VideoRecord']))
        # Adding index on 'VideoRecordPersonneRole', fields ['video_record']
        db.create_index(u'video_record_personne_role', ['video_record_id'])


        # Renaming column for 'VideoRecordCollectivite.video_record' to match new field type.
        db.rename_column(u'video_record_collectivite', 'video_record', 'video_record_id')
        # Changing field 'VideoRecordCollectivite.video_record'
        db.alter_column(u'video_record_collectivite', 'video_record_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.VideoRecord']))
        # Adding index on 'VideoRecordCollectivite', fields ['video_record']
        db.create_index(u'video_record_collectivite', ['video_record_id'])


    def backwards(self, orm):
        # Removing index on 'VideoRecordCollectivite', fields ['video_record']
        db.delete_index(u'video_record_collectivite', ['video_record_id'])

        # Removing index on 'VideoRecordPersonneRole', fields ['video_record']
        db.delete_index(u'video_record_personne_role', ['video_record_id'])


        # Renaming column for 'VideoRecordPersonneRole.video_record' to match new field type.
        db.rename_column(u'video_record_personne_role', 'video_record_id', 'video_record')
        # Changing field 'VideoRecordPersonneRole.video_record'
        db.alter_column(u'video_record_personne_role', 'video_record', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Renaming column for 'VideoRecordCollectivite.video_record' to match new field type.
        db.rename_column(u'video_record_collectivite', 'video_record_id', 'video_record')
        # Changing field 'VideoRecordCollectivite.video_record'
        db.alter_column(u'video_record_collectivite', 'video_record', self.gf('django.db.models.fields.CharField')(max_length=30))
