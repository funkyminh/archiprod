...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'PartieCollectivite.collectivite' to match new field type.
        db.rename_column(u'partie_collectivite', 'collectivite', 'collectivite_id')
        # Changing field 'PartieCollectivite.collectivite'
        db.alter_column(u'partie_collectivite', 'collectivite_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Collectivite']))
        # Adding index on 'PartieCollectivite', fields ['collectivite']
        db.create_index(u'partie_collectivite', ['collectivite_id'])


    def backwards(self, orm):
        # Removing index on 'PartieCollectivite', fields ['collectivite']
        db.delete_index(u'partie_collectivite', ['collectivite_id'])


        # Renaming column for 'PartieCollectivite.collectivite' to match new field type.
        db.rename_column(u'partie_collectivite', 'collectivite_id', 'collectivite')
        # Changing field 'PartieCollectivite.collectivite'
        db.alter_column(u'partie_collectivite', 'collectivite', self.gf('django.db.models.fields.IntegerField')())
