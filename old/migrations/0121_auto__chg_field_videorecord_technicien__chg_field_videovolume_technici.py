...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'video_record', 'technicien_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'VideoVolume.technicien'
        db.alter_column(u'video_volume', 'technicien_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'NoteProgramme.technicien'
        db.alter_column(u'note_programme', 'technicien_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Volume.technicien'
        db.alter_column(u'volume', 'technicien_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'Contrat.technicien'
        db.alter_column(u'contrat', 'technicien_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'VideoVolume.technicien'
        db.alter_column(u'video_volume', 'technicien_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Utilisateur'], null=True))
