...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VideoVolume.evenement2'
        db.add_column(u'video_volume', 'evenement2',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Evenement2'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'NoteProgramme.evenement2'
        db.add_column(u'note_programme', 'evenement2',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Evenement2'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Volume.evenement2'
        db.add_column(u'volume', 'evenement2',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Evenement2'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VideoVolume.evenement2'
        db.delete_column(u'video_volume', 'evenement2_id')

        # Deleting field 'NoteProgramme.evenement2'
        db.delete_column(u'note_programme', 'evenement2_id')

        # Deleting field 'Volume.evenement2'
        db.delete_column(u'volume', 'evenement2_id')
    ...
    models = {
        ...
        'old.evenement2': {
            ...
            'supprime': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'time_stamp': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'type_evenement': ('django.db.models.fields.IntegerField', [], {})
        },
        'old.lieu': {
