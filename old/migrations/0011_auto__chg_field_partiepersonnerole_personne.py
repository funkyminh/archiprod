...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'PartiePersonneRole.personne' to match new field type.
        db.rename_column(u'partie_personne_role', 'personne', 'personne_id')
        # Changing field 'PartiePersonneRole.personne'
        db.alter_column(u'partie_personne_role', 'personne_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Personne']))
        # Adding index on 'PartiePersonneRole', fields ['personne']
        db.create_index(u'partie_personne_role', ['personne_id'])


    def backwards(self, orm):
        # Removing index on 'PartiePersonneRole', fields ['personne']
        db.delete_index(u'partie_personne_role', ['personne_id'])


        # Renaming column for 'PartiePersonneRole.personne' to match new field type.
        db.rename_column(u'partie_personne_role', 'personne_id', 'personne')
        # Changing field 'PartiePersonneRole.personne'
        db.alter_column(u'partie_personne_role', 'personne', self.gf('django.db.models.fields.IntegerField')())
