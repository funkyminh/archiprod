...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Evenement', fields ['supprime']
        #db.delete_unique(u'evenement', ['supprime'])
        pass


    def backwards(self, orm):
        # Adding unique constraint on 'Evenement', fields ['supprime']
        #db.create_unique(u'evenement', ['supprime'])
        pass
