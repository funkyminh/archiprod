...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        '''
        from old.models import Evenement  # , TagEvenement  #,VideoVolume
        #video_volumes = VideoVolume.objects.all().exclude(parent_id=None)
        TreeManager().contribute_to_class(orm.Evenement, "objects")
    ...
    models = {
        ...
        'old.evenement': {
            #'MPTTMeta': {'object_name': 'Evenement', 'order_insertion_by': "u'intitule'"},
