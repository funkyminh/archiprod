...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Lieu.salle'
        db.alter_column(u'lieu', 'salle', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Lieu.salle'
        raise RuntimeError("Cannot reverse this migration. 'Lieu.salle' and its values cannot be restored.")
