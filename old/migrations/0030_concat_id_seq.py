...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        cursor.execute("UPDATE partie set id = CONCAT(id,'-',CAST(seq as CHAR)) WHERE seq >= 10")
        transaction.commit_unless_managed()
        cursor.execute("UPDATE partie set id = CONCAT(id,'-0',CAST(seq as CHAR)) WHERE seq < 10")
        transaction.commit_unless_managed()
