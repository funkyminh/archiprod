...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Volume.confidentialite_volume'
        db.alter_column(u'volume', 'confidentialite_volume', self.gf('django.db.models.fields.CharField')(max_length=1))

        # Changing field 'Volume.etat_collection'
        db.alter_column(u'volume', 'etat_collection', self.gf('django.db.models.fields.CharField')(max_length=1))

        # Changing field 'Volume.note2prog_id'
        db.alter_column(u'volume', 'note2prog_id', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'Volume.lieu'
        db.alter_column(u'volume', 'lieu_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Lieu'], null=True))

        # Changing field 'Volume.label'
        db.alter_column(u'volume', 'label', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Volume.notes_na'
        db.alter_column(u'volume', 'notes_na', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Volume.old_id'
        db.alter_column(u'volume', 'old_id', self.gf('django.db.models.fields.CharField')(max_length=384, null=True))

        # Changing field 'Volume.cddb'
        db.alter_column(u'volume', 'CDDB', self.gf('django.db.models.fields.CharField')(max_length=24, null=True, db_column='CDDB'))

        # Changing field 'Volume.time_stamp'
        db.alter_column(u'volume', 'time_stamp', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Volume.pending'
        db.alter_column(u'volume', 'pending', self.gf('django.db.models.fields.CharField')(max_length=1))

        # Changing field 'Volume.voltype'
        db.alter_column(u'volume', 'voltype', self.gf('django.db.models.fields.CharField')(max_length=1))

        # Changing field 'Volume.parent'
        db.alter_column(u'volume', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Evenement'], null=True))

        # Changing field 'Volume.resume'
        db.alter_column(u'volume', 'resume', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Volume.auteur'
        db.alter_column(u'volume', 'auteur', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Volume.pret'
        db.alter_column(u'volume', 'pret', self.gf('django.db.models.fields.CharField')(max_length=1))

        # Changing field 'Volume.annee'
        db.alter_column(u'volume', 'annee', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Volume.intitule'
        db.alter_column(u'volume', 'intitule', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Volume.etat_archive'
        db.alter_column(u'volume', 'etat_archive', self.gf('django.db.models.fields.CharField')(max_length=1))

        # Changing field 'Volume.url'
        db.alter_column(u'volume', 'url', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Volume.notes'
        db.alter_column(u'volume', 'notes', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Volume.intitule_na'
        db.alter_column(u'volume', 'intitule_na', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Volume.technicien'
        db.alter_column(u'volume', 'technicien_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['old.Utilisateur'], null=True))

    def backwards(self, orm):

        # Changing field 'Volume.confidentialite_volume'
        db.alter_column(u'volume', 'confidentialite_volume', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Volume.etat_collection'
        db.alter_column(u'volume', 'etat_collection', self.gf('django.db.models.fields.IntegerField')())

        # User chose to not deal with backwards NULL issues for 'Volume.note2prog_id'
        raise RuntimeError("Cannot reverse this migration. 'Volume.note2prog_id' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Volume.lieu'
        raise RuntimeError("Cannot reverse this migration. 'Volume.lieu' and its values cannot be restored.")

        # Changing field 'Volume.label'
        db.alter_column(u'volume', 'label', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Volume.notes_na'
        db.alter_column(u'volume', 'notes_na', self.gf('django.db.models.fields.TextField')(default=''))

        # User chose to not deal with backwards NULL issues for 'Volume.old_id'
        raise RuntimeError("Cannot reverse this migration. 'Volume.old_id' and its values cannot be restored.")

        # Changing field 'Volume.cddb'
        db.alter_column(u'volume', 'CDDB', self.gf('django.db.models.fields.CharField')(default='', max_length=24, db_column='CDDB'))

        # Changing field 'Volume.time_stamp'
        db.alter_column(u'volume', 'time_stamp', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Volume.pending'
        db.alter_column(u'volume', 'pending', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Volume.voltype'
        db.alter_column(u'volume', 'voltype', self.gf('django.db.models.fields.IntegerField')())

        # User chose to not deal with backwards NULL issues for 'Volume.parent'
        raise RuntimeError("Cannot reverse this migration. 'Volume.parent' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Volume.resume'
        raise RuntimeError("Cannot reverse this migration. 'Volume.resume' and its values cannot be restored.")

        # Changing field 'Volume.auteur'
        db.alter_column(u'volume', 'auteur', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Volume.pret'
        db.alter_column(u'volume', 'pret', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Volume.annee'
        db.alter_column(u'volume', 'annee', self.gf('django.db.models.fields.TextField')(default=''))

        # User chose to not deal with backwards NULL issues for 'Volume.intitule'
        raise RuntimeError("Cannot reverse this migration. 'Volume.intitule' and its values cannot be restored.")

        # Changing field 'Volume.etat_archive'
        db.alter_column(u'volume', 'etat_archive', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Volume.url'
        db.alter_column(u'volume', 'url', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Volume.notes'
        db.alter_column(u'volume', 'notes', self.gf('django.db.models.fields.TextField')(default=''))

        # User chose to not deal with backwards NULL issues for 'Volume.intitule_na'
        raise RuntimeError("Cannot reverse this migration. 'Volume.intitule_na' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Volume.technicien'
        raise RuntimeError("Cannot reverse this migration. 'Volume.technicien' and its values cannot be restored.")
    ...
    models = {
        ...
        'old.volume': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'intitule': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'intitule_na': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'notes': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'notes_na': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
