...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Archive.confidentiality'
        db.delete_column(u'archives_archive', 'confidentiality')


        # Changing field 'Media.confidentiality'
        db.alter_column(u'archives_media', 'confidentiality', self.gf('django.db.models.fields.CharField')(max_length=1))

    def backwards(self, orm):
        # Adding field 'Archive.confidentiality'
        db.add_column(u'archives_archive', 'confidentiality',
                      self.gf('django.db.models.fields.CharField')(default='0', max_length=1, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Media.confidentiality'
        db.alter_column(u'archives_media', 'confidentiality', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))
