...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Media.file_int'
        db.delete_column('archives_media', 'file_int')

        # Deleting field 'Media.file_ext'
        db.delete_column('archives_media', 'file_ext')


    def backwards(self, orm):
        # Adding field 'Media.file_int'
        db.add_column('archives_media', 'file_int',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Media.file_ext'
        db.add_column('archives_media', 'file_ext',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)
