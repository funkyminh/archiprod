...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        cursor1.execute("ALTER TABLE archives_archive ADD id INT(11) AUTO_INCREMENT, ADD INDEX (id)")

        cursor2 = connection.cursor()
        cursor2.execute("ALTER TABLE `archives_archive` DROP PRIMARY KEY , ADD PRIMARY KEY (`id`)")
