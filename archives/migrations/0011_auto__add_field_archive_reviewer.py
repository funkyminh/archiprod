...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Archive.reviewer'
        db.add_column('archives_archive', 'reviewer',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='reviewer', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Archive.reviewer'
        db.delete_column('archives_archive', 'reviewer_id')
