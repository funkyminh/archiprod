...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        db.execute('UPDATE archives_archive SET event_id = NULL WHERE event_id not in (SELECT id FROM events_event)')
        db.execute('UPDATE archives_archive SET set_id = NULL WHERE set_id not in (SELECT id FROM archives_set)')
    ...
    models = {
        u'archives.archive': {
            ...
            'confidentiality': ('django.db.models.fields.CharField', [], {'default': "'0'", 'max_length': '1', 'null': 'True', 'blank': 'True'}),
