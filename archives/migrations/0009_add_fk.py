...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        cursor1.execute("ALTER TABLE `archives_archive_collectivities` ADD CONSTRAINT FOREIGN KEY (`archive_id`) REFERENCES `archives_archive` (`id`)")

        cursor2 = connection.cursor()
        cursor2.execute("ALTER TABLE `archives_archive_tags` ADD CONSTRAINT FOREIGN KEY (`archive_id`) REFERENCES `archives_archive` (`id`)")

        cursor3 = connection.cursor()
        cursor3.execute("ALTER TABLE `archives_archiveparticipant` ADD CONSTRAINT FOREIGN KEY (`archive_id`) REFERENCES `archives_archive` (`id`)")

        cursor4 = connection.cursor()
        cursor4.execute("ALTER TABLE `archives_contract` ADD CONSTRAINT FOREIGN KEY (`archive_id`) REFERENCES `archives_archive` (`id`)")

        cursor5 = connection.cursor()
        cursor5.execute("ALTER TABLE `archives_media` ADD CONSTRAINT FOREIGN KEY (`archive_id`) REFERENCES `archives_archive` (`id`)")
