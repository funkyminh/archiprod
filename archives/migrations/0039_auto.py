...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('archives_participant_role_new', ['participant_id', 'role_id'])
        db.rename_table('archives_participant_role_new', 'archives_participant_role')
        db.create_unique('archives_participant_role', ['participant_id', 'role_id'])

        db.delete_unique('archives_archiveparticipant_role_new', ['archiveparticipant_id', 'role_id'])
        db.rename_table('archives_archiveparticipant_role_new', 'archives_archiveparticipant_role')
        db.create_unique('archives_archiveparticipant_role', ['archiveparticipant_id', 'role_id'])

        db.delete_unique('archives_media_collectivities_role_new', ['mediacollectivity_id', 'role_id'])
        db.rename_table('archives_media_collectivities_role_new', 'archives_media_collectivities_role')
        db.create_unique('archives_media_collectivities_role', ['mediacollectivity_id', 'role_id'])

        db.delete_unique('archives_archive_collectivities_role_new', ['archivecollectivity_id', 'role_id'])
        db.rename_table('archives_archive_collectivities_role_new', 'archives_archive_collectivities_role')
        db.create_unique('archives_archive_collectivities_role', ['archivecollectivity_id', 'role_id'])
    ...
    models = {
        ...
        u'archives.archivecollectivity': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'role': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'role_new3'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['utils.Role']"})
        },
        u'archives.archiveparticipant': {
            ...
            'role': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'role_new1'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['utils.Role']"})
        },
        u'archives.audio': {
        ...
        u'archives.mediacollectivity': {
            ...
            'role': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'role_new4'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['utils.Role']"})
        },
        ...
        u'archives.participant': {
            ...
            'media': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['archives.Media']"}),
            'person': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['utils.Person']"}),
            'role': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'role_new2'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['utils.Role']"})
        },
        u'archives.set': {
