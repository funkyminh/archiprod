...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Archive.time'
        db.alter_column('archives_archive', 'time', self.gf('django.db.models.fields.TimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Archive.time'
        db.alter_column('archives_archive', 'time', self.gf('django.db.models.fields.CharField')(max_length=5, null=True))
