...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        '''
        # Adding model 'MediaCollectivity'
        db.create_table('archives_media_collectivities', (
            ...
            ('collectivity', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['utils.Collectivity'])),
        ))
        db.send_create_signal(u'archives', ['MediaCollectivity'])

        # Adding unique constraint on 'MediaCollectivity', fields ['media', 'collectivity']
        db.create_unique('archives_media_collectivities', ['media_id', 'collectivity_id'])

        # Adding model 'ArchiveCollectivity'
        ...
        db.send_create_signal(u'archives', ['ArchiveCollectivity'])

        # Adding unique constraint on 'ArchiveCollectivity', fields ['archive', 'collectivity']
    ...
    def backwards(self, orm):
        '''
        # Removing unique constraint on 'ArchiveCollectivity', fields ['archive', 'collectivity']
        db.delete_unique('archives_archive_collectivities', ['archive_id', 'collectivity_id'])

        # Removing unique constraint on 'MediaCollectivity', fields ['media', 'collectivity']
        db.delete_unique('archives_media_collectivities', ['media_id', 'collectivity_id'])

        # Deleting model 'MediaCollectivity'
        db.delete_table('archives_media_collectivities')

        # Deleting model 'ArchiveCollectivity'
