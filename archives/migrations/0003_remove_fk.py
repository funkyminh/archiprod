...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        cursor1.execute("ALTER TABLE `archives_archive_collectivities` DROP FOREIGN KEY `archive_id_refs_id_fedc4c31c9e062`")

        cursor2 = connection.cursor()
        cursor2.execute("ALTER TABLE `archives_archive_tags` DROP FOREIGN KEY `archive_id_refs_id_e17e4aa503ea37a`")

        cursor3 = connection.cursor()
        cursor3.execute("ALTER TABLE `archives_archiveparticipant` DROP FOREIGN KEY `archive_id_refs_id_70c4d96145302177`")

        cursor4 = connection.cursor()
        cursor4.execute("ALTER TABLE `archives_contract` DROP FOREIGN KEY `archive_id_refs_id_185ba3d482709d56`")

        cursor5 = connection.cursor()
        cursor5.execute("ALTER TABLE `archives_media` DROP FOREIGN KEY `archive_id_refs_id_7ff8afe359a9a43f`")
