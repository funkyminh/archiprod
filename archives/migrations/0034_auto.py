...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        '''
        db.create_table(u'archives_archive_collectivities', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('archive', models.ForeignKey(orm[u'archives.archive'], null=False)),
            ('collectivity', models.ForeignKey(orm[u'utils.collectivity'], null=False))
        ))
        db.create_unique(u'archives_archive_collectivities', ['archive_id', 'collectivity_id'])

        # Adding M2M table for field collectivities on 'Media'
        db.create_table(u'archives_media_collectivities', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('media', models.ForeignKey(orm[u'archives.media'], null=False)),
            ('collectivity', models.ForeignKey(orm[u'utils.collectivity'], null=False))
        ))
        db.create_unique(u'archives_media_collectivities', ['media_id', 'collectivity_id'])
        '''
        pass
