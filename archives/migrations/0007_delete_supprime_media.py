...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        cursor1.execute("DELETE FROM archives_archive_collectivities WHERE archive_id like ('AU%%') OR archive_id like ('VI%%')")

        cursor2 = connection.cursor()
        cursor2.execute("DELETE FROM archives_archive_tags WHERE archive_id like ('AU%%') OR archive_id like ('VI%%')")

        cursor3 = connection.cursor()
        cursor3.execute("DELETE FROM archives_media WHERE archive_id like ('AU%%') OR archive_id like ('VI%%')")

        cursor4 = connection.cursor()
        cursor4.execute("DELETE FROM archives_archiveparticipant WHERE archive_id like ('AU%%') OR archive_id like ('VI%%')")
