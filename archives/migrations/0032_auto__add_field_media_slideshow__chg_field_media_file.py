...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Media.slideshow'
        db.add_column(u'archives_media', 'slideshow',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Media.file'
        db.alter_column(u'archives_media', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=1000, null=True))

    def backwards(self, orm):
        # Deleting field 'Media.slideshow'
        db.delete_column(u'archives_media', 'slideshow')


        # Changing field 'Media.file'
        db.alter_column(u'archives_media', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))
