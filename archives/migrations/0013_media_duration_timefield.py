...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Media.duration'
        db.alter_column('archives_media', 'duration', self.gf('django.db.models.fields.TimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Media.duration'
        db.alter_column('archives_media', 'duration', self.gf('django.db.models.fields.CharField')(max_length=12, null=True))
