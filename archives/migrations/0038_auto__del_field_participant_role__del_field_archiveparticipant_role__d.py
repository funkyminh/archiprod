...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'archives_participant', 'role_id')

        # Deleting field 'ArchiveParticipant.role'
        db.delete_column(u'archives_archiveparticipant', 'role_id')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Participant.role'
        raise RuntimeError("Cannot reverse this migration. 'Participant.role' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'ArchiveParticipant.role'
        raise RuntimeError("Cannot reverse this migration. 'ArchiveParticipant.role' and its values cannot be restored.")
