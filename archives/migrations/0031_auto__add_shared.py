...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Shared'
        db.create_table(u'archives_shared', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('media', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['archives.Media'], unique=True)),
            ('dailymotion', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('vimeo', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('youtube', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('soundcloud', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal(u'archives', ['Shared'])


    def backwards(self, orm):
        # Deleting model 'Shared'
        db.delete_table(u'archives_shared')
