...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProgramNote.program_ext'
        db.delete_column('events_programnote', 'program_ext')

        # Deleting field 'ProgramNote.program_int'
        db.delete_column('events_programnote', 'program_int')


    def backwards(self, orm):
        # Adding field 'ProgramNote.program_ext'
        db.add_column('events_programnote', 'program_ext',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProgramNote.program_int'
        db.add_column('events_programnote', 'program_int',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)
