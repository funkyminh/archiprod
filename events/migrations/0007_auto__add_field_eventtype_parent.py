...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventType.parent'
        db.add_column(u'events_eventtype', 'parent',
                      self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['events.EventType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventType.parent'
        db.delete_column(u'events_eventtype', 'parent_id')
