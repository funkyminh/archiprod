...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventType.lft'
        db.add_column(u'events_eventtype', 'lft',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True),
                      keep_default=False)

        # Adding field 'EventType.rght'
        db.add_column(u'events_eventtype', 'rght',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True),
                      keep_default=False)

        # Adding field 'EventType.tree_id'
        db.add_column(u'events_eventtype', 'tree_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True),
                      keep_default=False)

        # Adding field 'EventType.level'
        db.add_column(u'events_eventtype', 'level',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventType.lft'
        db.delete_column(u'events_eventtype', 'lft')

        # Deleting field 'EventType.rght'
        db.delete_column(u'events_eventtype', 'rght')

        # Deleting field 'EventType.tree_id'
        db.delete_column(u'events_eventtype', 'tree_id')

        # Deleting field 'EventType.level'
        db.delete_column(u'events_eventtype', 'level')
    ...
    models = {
        ...
        u'events.event': {
            ...
            'parent': ('mptt.fields.TreeForeignKey', [], {'blank': 'True', 'related_name': "'children'", 'null': 'True', 'to': u"orm['events.Event']"}),
        ...
        u'events.programnote': {
            ...
            'participants': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['utils.Person']", 'null': 'True', 'through': u"orm['events.NoteParticipant']", 'blank': 'True'}),
            'program': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'publisher': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['utils.Collectivity']", 'null': 'True', 'blank': 'True'}),
