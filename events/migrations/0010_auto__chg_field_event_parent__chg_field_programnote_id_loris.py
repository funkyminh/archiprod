...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'events_event', 'parent_id', self.gf('mptt.fields.TreeForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['events.Event']))

        # Changing field 'ProgramNote.id_loris'
        db.alter_column(u'events_programnote', 'id_loris', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

    def backwards(self, orm):

        # Changing field 'Event.parent'
        db.alter_column(u'events_event', 'parent_id', self.gf('mptt.fields.TreeForeignKey')(null=True, to=orm['events.Event']))

        # Changing field 'ProgramNote.id_loris'
        db.alter_column(u'events_programnote', 'id_loris', self.gf('django.db.models.fields.CharField')(default=None, max_length=15))
    ...
    models = {
        ...
        u'events.programnote': {
            ...
            'event_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['events.EventType']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'id_loris': ('django.db.models.fields.CharField', [], {'max_length': '15', 'null': 'True', 'blank': 'True'}),
